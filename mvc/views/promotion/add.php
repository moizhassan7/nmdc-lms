...
<div class="col-sm-4 col-sm-offset-2 list-group" style="margin-top:5px;">
             ...
             echo form_dropdown("type", $typeArray, set_value("type"), "id='type' class='form-control select2'");
                ...
                <div class="col-sm-6 list-group" style="margin-top: 27px;">
    ...
    $('#save').click(function() {
        if ($('.promotion').filter(':checked').length == 0) {
            ...
            $.ajax({
				...
				data: "studentIDs=" + result + "&type=" + type,
                dataType: "html",
                success: function(data) {
    ...
    $('#enroll').click(function() {
        if ($('.promotion').filter(':checked').length == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('promotion/promotion_to_next_class')?>",
                data: "studentIDs=" + result + "&type=" + type + "&enroll=true",
