...
<input type="hidden" value="<?=set_value('tr_id', $payment->tr_id)?>" name="tr_id">
<input type="hidden" value="<?=set_value('panel_payment_type', $payment->panel_payment_type)?>" name="panel_payment_type">
                    <?php 
           ...
           <?=$this->lang->line("paymenthistory_paymentmethod")?> <span class="text-red">*</span>
                        ...
                        <div class="col-sm-6">
                            <?php
								...
								$array['Bank Deposit'] = $this->lang->line('BankDeposit');
								$array['Bank Draft'] = $this->lang->line('BankDraft');
								$array['Online Payment'] = $this->lang->line('OnlinePayment');
