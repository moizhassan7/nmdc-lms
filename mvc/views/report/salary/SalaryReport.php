...
$totalnet_salary = 0;
$totalSalary = 0;
$i=1; if(customCompute($salarys)) { foreach($salarys as $salary) {?>
                                    <tr>
...
<?php
echo $salary->voucher_number;
?>
</td>

<td data-title="Basic Salary">
<?php
echo number_format($salary->basic_salary,2);
$totalbasic_salary += $salary->basic_salary;
?>
</td>
<td data-title="Allowances">
<?php
echo number_format($salary->total_allowances,2);
$total_allowances += $salary->total_allowances;
?>
</td>
<td data-title="Gross Salary">
<?php
echo number_format($salary->gross_salary,2);
$totalgross_salary += $salary->gross_salary;
?>
</td>
<td data-title="Deductions">
<?php
echo number_format($salary->total_deduction,2);
$total_deduction += $salary->total_deduction;
?>
</td>
<td data-title="Net Salary">
<?php
echo number_format($salary->net_salary,2);
$totalnet_salary += $salary->net_salary;
?>
</td>
...
?>
                                    ...
                                    <?php $i++; } } ?>
                                <tr>
                                    <td data-title="<?=$this->lang->line('salaryreport_grand_total')?>" colspan="7" class="text-bold text-right"><?=$this->lang->line('salaryreport_grand_total')?> <?=!empty($siteinfos->currency_code) ? "(".$siteinfos->currency_code.")" : ''?></td>

<td data-title="Basic Salary" class="text-bold">
<?=number_format($totalbasic_salary,2)?></td>

<td data-title="Allowances" class="text-bold">
<?=number_format($total_allowances,2)?></td>

<td data-title="Gross Salary" class="text-bold">
<?=number_format($totalgross_salary,2)?></td>

<td data-title="Deductions" class="text-bold">
<?=number_format($total_deduction,2)?></td>

<td data-title="Net Salary" class="text-bold">
<?=number_format($totalnet_salary,2)?></td>
