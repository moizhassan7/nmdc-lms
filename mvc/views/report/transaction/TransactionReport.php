                ...
                <div class="col-sm-12" style="margin-top:0px">
                   <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a  class="transction-tab" data-toggle="tab" href="#liability_details" aria-expanded="true">Liability Details</a></li>
...
<th>Voucher No.</th>
<th colspan="2"><?=$this->lang->line('transactionreport_name')?></th>
...
<?php 
echo $voucher_number = $get_payment->voucher_number;
?>
</td>
                                                    <td colspan="2" data-title="<?=$this->lang->line('transactionreport_name')?>"><?=isset($students[$get_payment->studentID]) ? $students[$get_payment->studentID]->srname : ''?></td>
                                            ...
                                            <?php $i++; } } } ?>
                                            <tr>
                                                <td data-title="<?=$this->lang->line('transactionreport_grand_total')?>" colspan="9" class="text-right text-bold"><?=$this->lang->line('transactionreport_grand_total')?> <?=!empty($siteinfos->currency_code) ? "(".$siteinfos->currency_code.")" : ''?></td>
...
<?php
$this->data['accounts'] = $this->accounts_m->get_single_accounts(array('accountsID' => $income->accountsID));
...
<td data-title="Income Head">
<?php
$this->data['incomehead'] = $this->incomehead_m->get_single_incomehead(array('incomeheadID' => $income->incomeheadID));

if(customCompute($this->data['incomehead'])) {

echo $income_head = $this->data['incomehead']->income_head;
	
}
?>
</td>

<td data-title="<?=$this->lang->line('transactionreport_name')?>">
<?php 
if($income->name == 1){
echo "Fee via Invoice";
}else if($income->name == 2){
echo "Fine via Invoice";
}
else{ echo $income->name;}
?> 
</td>
<td data-title="<?=$this->lang->line('transactionreport_date')?>"><?=date('d M Y',strtotime($income->date))?></td>
<td data-title="Voucher Number">
<?php 
echo $voucher_number = $income->voucher_number;
?>
</td>
...
<?php $i++; } } ?>
                                            <tr>
                                                <td data-title="<?=$this->lang->line('transactionreport_grand_total')?>" colspan="6" class="text-bold text-right"><?=$this->lang->line('transactionreport_grand_total')?> <?=!empty($siteinfos->currency_code) ? "(".$siteinfos->currency_code.")" : ''?></td>
                            ...
                            <div id="liability_details" class="tab-pane">
                                <div id="hide-table">
<table id="example1" class="table table-striped table-bordered table-hover">
                                        <thead>
                                            <tr>
...
echo "Liability via Invoice";
}else{ echo $liability->liability;}
?> 
</td>
<td data-title="<?=$this->lang->line('transactionreport_date')?>"><?=date('d M Y',strtotime($liability->date))?></td>
<td data-title="Voucher Number">
<?php 
echo $voucher_number = $liability->voucher_number;
?>
</td>
<td data-title="<?=$this->lang->line('transactionreport_amount')?>">
<?php 
...
<?php $i++; } } ?>
                                            <tr>
                                                <td data-title="<?=$this->lang->line('transactionreport_grand_total')?>" colspan="6" class="text-bold text-right"><?=$this->lang->line('transactionreport_grand_total')?> <?=!empty($siteinfos->currency_code) ? "(".$siteinfos->currency_code.")" : ''?></td>
                                                <td data-title="<?=$this->lang->line('transactionreport_total_amount')?>" class="text-bold"> <?=number_format($totalliability,2)?></td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
...
<td data-title="Voucher Number">
<?php 
echo $voucher_number = $expense->voucher_number;
?>
</td>
<td data-title="<?=$this->lang->line('transactionreport_amount')?>">
                                                    <?php
...
<td data-title="Account Name">
<?php
$this->data['accounts'] = $this->accounts_m->get_single_accounts(array('accountsID' => $salary->accountsID));
if(customCompute($this->data['accounts'])) {
echo $account_name = $this->data['accounts']->account_name;
}
?>
...
<td data-title="Voucher Number">
<?php 
echo $voucher_number = $salary->voucher_number;
?>
</td>
<td data-title="<?=$this->lang->line('transactionreport_type')?>"><?=isset($usertypes[$salary->usertypeID]) ? $usertypes[$salary->usertypeID] : ''?></td>

<td data-title="Faculty Type"><?=isset($allUserName[$salary->usertypeID][$salary->userID]) ? $allUserName[$salary->usertypeID][$salary->userID]->FacultyType : ''?></td>

<td data-title="Department"><?=isset($allUserName[$salary->usertypeID][$salary->userID]) ? $allUserName[$salary->usertypeID][$salary->userID]->Department : ''?></td>

<td data-title="Designation"><?=isset($allUserName[$salary->usertypeID][$salary->userID]) ? $allUserName[$salary->usertypeID][$salary->userID]->designation : ''?></td>
...
?>
                                            ...
                                            <?php $i++; } } ?>
                                            <tr>
                                                 <td data-title="<?=$this->lang->line('transactionreport_grand_total')?>" colspan="10" class="text-bold text-right"><?=$this->lang->line('transactionreport_grand_total')?> <?=!empty($siteinfos->currency_code) ? "(".$siteinfos->currency_code.")" : ''?></td>
