...
<th>Voucher No.</th>
<th colspan="2"><?=$this->lang->line('feesreport_name')?></th>
<?php if(!($classesID > 0)) { ?>
                                ...
                                <?php
                                    ...
                                    foreach($getFeesReports as $getFeesReport) { 
                                        ...
                                        <tr>
                     					...
                     					<?=$getFeesReport->voucher_number?>
                                            </td>
                                            
                                            <td colspan="2" data-title="<?=$this->lang->line('feesreport_name')?>"><?=isset($students[$getFeesReport->studentID]) ? $students[$getFeesReport->studentID]->srname : '' ?></td>
