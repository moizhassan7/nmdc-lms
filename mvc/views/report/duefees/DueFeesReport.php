                            ...
                            <table class="table table-bordered table-responsive">
                                <thead>
                                    <tr>
                                        ...
                                        <th colspan="2"><?=$this->lang->line('duefeesreport_invoice_date')?></th>
                                    ...
                                    <?php $totalDue = 0; $i = 0; foreach($getDueFeesReports as $getDueFeesReport) { 
                                        if($sectionID > 0) { if(isset($students[$getDueFeesReport->studentID]) && $students[$getDueFeesReport->studentID]->srsectionID == $sectionID) { $i++; ?>
                                            <tr>
                                                ...
                                                <td colspan="2" data-title="<?=$this->lang->line('duefeesreport_invoice_date')?>"><?=date('d M Y',strtotime($getDueFeesReport->create_date))?></td>
