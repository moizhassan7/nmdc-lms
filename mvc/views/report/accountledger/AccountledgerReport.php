                    ...
                    <div class="row">
                        <div class="singleaccountledger">
                            <table class="table table-bordered marginledgerreport">
                                <tr>
                                    <td class="text-bold" colspan="2"><?=$this->lang->line('accountledgerreport_totalincome')?></td>
                                </tr>
                                <tr>
         <td colspan="2"><?=$this->lang->line('accountledgerreport_income_des')?></td>
                                </tr>
                                <tr>
                  <td><?=$this->lang->line('accountledgerreport_infees_collections')?> </td>
                         <td><?=number_format($totalcollectionincome,2)?></td>
                                </tr>
                                <tr>
      <td><?=$this->lang->line('accountledgerreport_fines')?> via Fees Collections </td>
                                    <td><?=number_format($totalfine,2)?></td>
                                </tr>
                                <tr>
                     <td>General <?=$this->lang->line('accountledgerreport_income')?></td>
<?php
...
?>                                    
                         ...
                         <td><?=number_format($totalcollectionincome,2)?></td>
                                ...
                                <tr>
                         <td><?=$this->lang->line('accountledgerreport_liability_collections')?> (+)</td>
...
?>                                    
                                ...
                                <tr>
                          <td>General <?=$this->lang->line('accountledgerreport_liabilityz')?> (+)</td>
...
echo number_format($mainbalance,2);
                        ...
                        <div class="singleaccountledger">
                            ...
                            <table class="table table-bordered marginledgerreport">
                                <tr>
                                    <td class="text-bold" colspan="2"><?=$this->lang->line('accountledgerreport_tfees_collections')?></td>
                                </tr>
                                <tr>
                                    <td colspan="2"><?=$this->lang->line('accountledgerreport_fees_collections_des')?></td>
                                </tr>
                                <tr>
              <td><?=$this->lang->line('accountledgerreport_total')?> Income</td>
              <td><?=number_format($totalcollectionincome,2)?></td>
                                </tr>
                                <tr>
              <td><?=$this->lang->line('accountledgerreport_total')?> Liability</td>
              <td><?=number_format($totalcollectionliability,2)?></td>
                                </tr>
                                <tr>
                                    <td><?=$this->lang->line('accountledgerreport_total')?> <span class="text-bold"><?=!empty($siteinfos->currency_code) ? "(".$siteinfos->currency_code.")" : ''?></span></td>
...
<td><b><?=number_format($totalcollectionliability + $totalliabilityz,2)?></b></td>
                            ...
                            <table class="table table-bordered marginledgerreport">
                                <tr>
                                    <td class="text-bold" colspan="2">Total <?=$this->lang->line('accountledgerreport_fines')?></td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-bordered marginledgerreport">
                                <tr>
                                    <td class="text-bold" colspan="2">Total <?=$this->lang->line('accountledgerreport_expense')?>s</td>
                                </tr>
                                <tr>
                            ...
                            <table class="table table-bordered marginledgerreport">
                                <tr>
                       <td class="text-bold" colspan="2">Total Salaries</td>
                                </tr>
                                <tr>
