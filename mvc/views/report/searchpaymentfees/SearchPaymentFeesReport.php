                                    ...
                                    <table class="table info">
                                        <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_classes')?> : </b> <?=customCompute($studentinfo) ? $studentinfo->srclasses  : ''?></td>
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_roll')?> : </b> <?=customCompute($studentinfo) ? $studentinfo->srroll : ''?></td>
                                            </tr>
                                            
                                            <tr>    
                                                <td><b><?=$this->lang->line('searchpaymentfeesreport_section')?> : </b><?=customCompute($studentinfo) ? $studentinfo->srsection  : ''?></td>
...
<th class="textright"><?=$this->lang->line('searchpaymentfeesreport_amount')?></th>
                               ...
                               <?=isset($payment->feetype) ? $payment->feetype : ''?>
                                                ...
                                                <td>
              <?=isset($payment->voucher_number) ? $payment->voucher_number : ''?>
                                                </td>
                                                <td class="textright">
                                        ...
                                        if(customCompute($globalpayments)) { foreach($globalpayments as $payment) {
                                            ...
                                            <?php } 
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="boldandred textright" colspan="2"><?=$paymentedFineAmount?></td>
                                                </tr>
                                        <?php } } ?>

                                        <tr>
                                            <td class="boldandred"><?=$this->lang->line('searchpaymentfeesreport_grand_total')?></td>
                                     <td class="boldandred textright" colspan="2"><?=$paymentedPaidAmount+$paymentedFineAmount?></td>
                                        </tr>
                    ...
                    <div class="row invoice-info">
                        ...
                        <?php if(customCompute($studentinfo)) { ?>
                            ...
                            <div class="col-sm-4 invoice-col" style="font-size: 16px;">
                                ...
                                <br>
                             <?="Voucher Number : "."<span>".$voucher_number."</span>"?>
                            </div>
                        <?php } ?>
                    </div>
