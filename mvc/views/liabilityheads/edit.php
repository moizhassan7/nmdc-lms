...
<li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
  ...
  <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('panel_titleb')?></li>
    ...
    <div class="box-body">
            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="liability_head" name="liability_head" value="<?=set_value('liability_head', $liability->liability_head)?>" >
                        </div>
     ...
     <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_liability")?> Head">
                        </div>
                    </div>
                </form>
            </div>
