            ...
            <div class="col-sm-12">
               ...
               <?=$this->lang->line("parents_father_profession")?> <span class="text-red">*</span>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="phone_off" name="phone_off" value="<?=set_value('phone_off')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="phone_res" name="phone_res" value="<?=set_value('phone_res')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
