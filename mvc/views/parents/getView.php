...
<b><?=$this->lang->line('parents_cell')?></b> <a class="pull-right"><?=$profile->phone?></a>
                            </li>
                        </ul>
                    </div>
                </div>
                            ...
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <div class="profile-view-tab">
                                     ...
                                     <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("parents_phone_off")?> </span>: <?=$profile->phone_off?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("parents_phone_res")?> </span>: <?=$profile->phone_res?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><?=$this->lang->line("parents_email")?> </span>: <?=$profile->email?></p>
                                    </div>
                                    <div class="profile-view-tab" style="width:100%">
                                        <p><span style="width:10%"><?=$this->lang->line("parents_address")?> </span>: <?=$profile->address?></p>
                                    </div>
