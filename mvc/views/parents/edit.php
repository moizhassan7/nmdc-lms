                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        <label for="mother_name" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_mother_name")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="father_profession" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_father_profession")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="mother_profession" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_mother_profession")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    <?php 
                        if(form_error('phoneoff')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="phone_off" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_phone_off")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="phone_off" name="phone_off" value="<?=set_value('phone_off', $parents->phone_off)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('phoneoff'); ?>
                        </span>
                    </div>
                    
                    <?php 
                        if(form_error('phoneres')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="phone_res" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_phone_res")?>
                        </label>
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="phone_res" name="phone_res" value="<?=set_value('phone_res', $parents->phone_res)?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('phoneres'); ?>
                        </span>
                    </div>
                    ...
                    ?>
                        <label for="phone" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_cell")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                    ...
                    ?>
                        <label for="address" class="col-sm-2 control-label">
                            <?=$this->lang->line("parents_address")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
