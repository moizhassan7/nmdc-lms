        ...
        <div class="row">
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post">
                        ...
                        <?php
                        if(form_error('panel_payment_type'))
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="panel_payment_type" class="col-sm-2 control-label">
                       <?=$this->lang->line("panel_payment_type")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <?php
                                $panel_payment_typeArray = array(
                                    'Income' => 'Income',
                                    'Liability' => 'Liability'
                                );
                                echo form_dropdown("panel_payment_type", $panel_payment_typeArray, set_value("panel_payment_type", $feetypes->panel_payment_type), " id='panel_payment_type' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('panel_payment_type'); ?>
                        </span>
                    </div>
