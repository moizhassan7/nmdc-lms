<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_add')?> Faculty</li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                  <input type="text" class="form-control" id="pmdcno" name="pmdcno" value="<?=set_value('pmdcno')?>" >
                        </div>
                        <span class="control-label">
...
<td><input type="text" name="MBBSmarks" class="form-control" id="MBBSmarks" value="<?=set_value('MBBSmarks')?>"></td>
<td><input type="text" name="MBBSinst" class="form-control" id="MBBSinst" value="<?=set_value('MBBSinst')?>"></td>
</tr>
<tr>
<th>Mphil</th>
<td>
...
<td><input type="text" name="Mphilmarks" class="form-control" id="Mphilmarks" value="<?=set_value('Mphilmarks')?>"></td>
<td><input type="text" name="Mphilinst" class="form-control" id="Mphilinst" value="<?=set_value('Mphilinst')?>"></td>
</tr>
<tr>
<th>FCPS</th>
<td>
...
<td><input type="text" name="FCPSmarks" class="form-control" id="FCPSmarks" value="<?=set_value('FCPSmarks')?>"></td>
<td><input type="text" name="FCPSinst" class="form-control" id="FCPSinst" value="<?=set_value('FCPSinst')?>"></td>
</tr>
<tr>
<th>MCPS</th>
<td>
...
<td><input type="text" name="MCPSmarks" class="form-control" id="MCPSmarks" value="<?=set_value('MCPSmarks')?>"></td>
<td><input type="text" name="MCPSinst" class="form-control" id="MCPSinst" value="<?=set_value('MCPSinst')?>"></td>
</tr>
<tr>
<th>PHD</th>
<td>
...
<td><input type="text" name="MRCPmarks" class="form-control" id="MRCPmarks" value="<?=set_value('MRCPmarks')?>"></td>
<td><input type="text" name="MRCPinst" class="form-control" id="MRCPinst" value="<?=set_value('MRCPinst')?>"></td>
</tr>
<tr>
<th>MRCS</th>
<td>
...
<td><input type="text" name="MRCSmarks" class="form-control" id="MRCSmarks" value="<?=set_value('MRCSmarks')?>"></td>
<td><input type="text" name="MRCSinst" class="form-control" id="MRCSinst" value="<?=set_value('MRCSinst')?>"></td>
</tr>
<tr>
<th>MRCPCH</th>
<td>
...
<td><input type="text" name="MRCPCHmarks" class="form-control" id="MRCPCHmarks" value="<?=set_value('MRCPCHmarks')?>"></td>
<td><input type="text" name="MRCPCHinst" class="form-control" id="MRCPCHinst" value="<?=set_value('MRCPCHinst')?>"></td>
</tr>
<tr>
<th>MPH</th>
<td>
...
<td><input type="text" name="MPHmarks" class="form-control" id="MPHmarks" value="<?=set_value('MPHmarks')?>"></td>
<td><input type="text" name="MPHinst" class="form-control" id="MPHinst" value="<?=set_value('MPHinst')?>"></td>
</tr>
<tr>
<th>MS/MD</th>
<td>
...
<td><input type="text" name="MS_MDmarks" class="form-control" id="MS_MDmarks" value="<?=set_value('MS_MDmarks')?>"></td>
<td><input type="text" name="MS_MDinst" class="form-control" id="MS_MDinst" value="<?=set_value('MS_MDinst')?>"></td>
</tr>
</table>
</div>
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input class="form-control" id="phone" name="phone" value="<?=set_value('phone')?>" data-inputmask="'mask': '0399-99999999'" type="text" maxlength= "12">
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
       ...
       <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_teacher")?>" style="float:right; margin-right:20px;">
                        </div>
                    </div>
