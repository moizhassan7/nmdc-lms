...
<th class="col-sm-2"><?=$this->lang->line('teacher_FacultyType')?></th>
<th class="col-sm-1"><?=$this->lang->line('teacher_Department')?></th>
<th class="col-sm-2"><?=$this->lang->line('teacher_designation')?></th>
...
<?php if(customCompute($teachers)) {$i = 1; foreach($teachers as $teacher) { ?>
                         ...
                         <td data-title="<?=$this->lang->line('teacher_FacultyType')?>">
                         <?php echo $teacher->FacultyType; ?>
                         </td>
                         <td data-title="<?=$this->lang->line('teacher_Department')?>">
                         <?php echo $teacher->Department; ?>
                         </td>
                         <td data-title="<?=$this->lang->line('teacher_designation')?>">
