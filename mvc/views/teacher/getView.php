...
<p><span><?=$this->lang->line("teacher_username")?> </span>: <?=$profile->username?></p>
                                    ...
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_name")?> </span>: <?=$profile->name?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_empcode")?> </span>: <?=$profile->empcode?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_cnic")?> </span>: <?=$profile->cnic?></p>
                                    </div>
                                    <div class="profile-view-tab" style="width:100%;">
<p><span style="width:30%;"><?=$this->lang->line("teacher_fathname")?> </span>: <?=$profile->fathname?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_dob")?> </span>: <?=date("d M Y", strtotime($profile->dob))?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_sex")?> </span>: <?=$profile->sex?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_state")?> </span>: <?=$profile->state?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_domicile")?> </span>: <?=$profile->domicile?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_marstatus")?> </span>: <?=$profile->marstatus?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_religion")?> </span>: <?=$profile->religion?></p>
                                    </div>
                                    <?php if($profile->religion=="Muslim"){?>
                                    <div class="profile-view-tab">
<p><span>Sect </span>: <?=$profile->sect?></p>
                                    </div>
                                    <?php }else{ ?>
                                    <div class="profile-view-tab">
<p><span>Non-Muslim Religion </span>: <?=$profile->sectb?></p>
                                    </div>
                                    <?php } ?>
                                    <div class="profile-view-tab" style="width:100%;">
<p><span style="width:35%;"><?=$this->lang->line("teacher_nextofkin")?> (Name and Relation)</span>: <?=$profile->nextofkin?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_bgroup")?> </span>: <?=$profile->bgroup?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_nativelang")?> </span>: <?=$profile->nativelang?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span>PMDC/PMC No </span>: <?=$profile->pmdcno?></p>
                                    </div>
                                    
<div class="clearfix"></div>
<p class="form_titlez">OFFICIAL INFORMATION</p>                    
                                    <div class="profile-view-tab">
<?php if(empty($profile->AppointmentDate)){ ?>
<p><span><?=$this->lang->line("teacher_AppointmentDate")?> </span>: <?= $profile->AppointmentDate ?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("teacher_AppointmentDate")?> </span>: <?=date("d M Y", strtotime($profile->AppointmentDate))?></p>
<?php } ?>

                                    </div>
                                    <div class="profile-view-tab">
<?php if(empty($profile->jod)){ ?>
<p><span><?=$this->lang->line("teacher_jod")?> </span>: <?= $profile->jod ?></p>
<?php }else{ ?>
...
<?php } ?>
                                    ...
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_FacultyType")?> </span>: <?=$profile->FacultyType?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_Department")?> </span>: <?=$profile->Department?></p>
                                    </div>
                                    <div class="profile-view-tab" style="width:100%">
<p><span><?=$this->lang->line("teacher_designation")?> </span>: <?=$profile->designation?></p>
                                    </div>
<div class="clearfix"></div>
                                    <div class="profile-view-tab" style="width:100%">
<p><span><?=$this->lang->line("teacher_currentdesignation")?> </span>: <?=$profile->currentdesignation?></p>
                                    </div>
<div class="clearfix"></div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_Qualification")?> </span>: <?=$profile->Qualification?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_Specialization")?> </span>: <?=$profile->Specialization?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_EmploymentMode")?> </span>: <?=$profile->EmploymentMode?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_EmploymentStatus")?> </span>: <?=$profile->EmploymentStatus?></p>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<?php if(empty($profile->ContractStartDate)){ ?>
<p><span><?=$this->lang->line("teacher_ContractStartDate")?> </span>: <?=$profile->ContractStartDate?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("teacher_ContractStartDate")?> </span>: <?=date("d M Y", strtotime($profile->ContractStartDate))?></p>
<?php } ?>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<?php if(empty($profile->ContractEndDate)){ ?>
<p><span><?=$this->lang->line("teacher_ContractEndDate")?> </span>: <?=$profile->ContractEndDate?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("teacher_ContractEndDate")?> </span>: <?=date("d M Y", strtotime($profile->ContractEndDate))?></p>
<?php } ?>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<?php if(empty($profile->LastPromotionDate)){ ?>
<p><span><?=$this->lang->line("teacher_LastPromotionDate")?> </span>: <?=$profile->LastPromotionDate?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("teacher_LastPromotionDate")?> </span>: <?=date("d M Y", strtotime($profile->LastPromotionDate))?></p>
<?php } ?>
                                    </div>
...
<tr>
<th>MBBS</th>
<td><?=$profile->MBBSyear?></td>
<td><?=$profile->MBBSmarks?></td>
<td><?=$profile->MBBSinst?></td>
</tr>
</tr>
<tr>
<th>Mphil</th>
<td><?=$profile->Mphilyear?></td>
<td><?=$profile->Mphilmarks?></td>
<td><?=$profile->Mphilinst?></td>
</tr>
<tr>
<tr>
<th>FCPS</th>
<td><?=$profile->FCPSyear?></td>
<td><?=$profile->FCPSmarks?></td>
<td><?=$profile->FCPSinst?></td>
</tr>
<th>MCPS</th>
<td><?=$profile->MCPSyear?></td>
<td><?=$profile->MCPSmarks?></td>
<td><?=$profile->MCPSinst?></td>
</tr>
<tr>
<th>PHD</th>
<td><?=$profile->PHDyear?></td>
<td><?=$profile->PHDmarks?></td>
<td><?=$profile->PHDinst?></td>
</tr>
<tr>
<th>MRCP</th>
<td><?=$profile->MRCPyear?></td>
<td><?=$profile->MRCPmarks?></td>
<td><?=$profile->MRCPinst?></td>
</tr>
<tr>
<th>MRCS</th>
<td><?=$profile->MRCSyear?></td>
<td><?=$profile->MRCSmarks?></td>
<td><?=$profile->MRCSinst?></td>
</tr>
<tr>
<th>MRCPCH</th>
<td><?=$profile->MRCPCHyear?></td>
<td><?=$profile->MRCPCHmarks?></td>
<td><?=$profile->MRCPCHinst?></td>
</tr>
<tr>
<th>MPH</th>
<td><?=$profile->MPHyear?></td>
<td><?=$profile->MPHmarks?></td>
<td><?=$profile->MPHinst?></td>
</tr>
<tr>
<th>MS/MD</th>
<td><?=$profile->MS_MDyear?></td>
<td><?=$profile->MS_MDmarks?></td>
<td><?=$profile->MS_MDinst?></td>
</tr>
</table>
</div>
...
<p class="form_titlez">CORRESPONDENCE INFORMATION</p>
                                    ...
                                    <div class="profile-view-tab" style="width:100%">
<p><span style="width:25%"><?=$this->lang->line("teacher_PermanentAddress")?> </span>: <?=$profile->PermanentAddress?></p>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<p><span style="width:25%"><?=$this->lang->line("teacher_address")?> </span>: <?=$profile->address?></p>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_phone")?> </span>: <?=$profile->phone?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_email")?> </span>: <?=$profile->email?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_LandlineNo")?> </span>: <?=$profile->LandlineNo?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("teacher_username")?> </span>: <?=$profile->username?></p>
                                    </div>
