        ...
        <div class="box">
            ...
            <div class="box-body box-profile">
                ...
                <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item" style="background-color: #FFF">
                        <b><?=$this->lang->line('manage_FacultyType')?></b>
                    </li>
                    <li class="list-group-item" style="background-color: #FFF">
                        <a><?=$user->FacultyType?></a>
                    </li>
                    <li class="list-group-item" style="background-color: #FFF">
                        <b><?=$this->lang->line('manage_Department')?></b>
                    </li>
                    <li class="list-group-item" style="background-color: #FFF">
                        <a><?=$user->Department?></a>
                    </li>
                    <li class="list-group-item" style="background-color: #FFF">
                        <b><?=$this->lang->line('manage_designation')?></b>
                    </li>
                    <li class="list-group-item" style="background-color: #FFF">
...
<div class="form-group <?=form_error('orginalNetsalary') ? 'has-error' : '' ?>">
                            <label for="orginalNetsalary"><?=$this->lang->line('make_payment_basic_salary')?> <span class="text-red">*</span></label>
                            <input type="text" name="orginalNetsalary" class="form-control" id="orginalNetsalary" value="<?=set_value('orginalNetsalary', $orginalNetsalary)?>" disabled>
                        </div>
                        
<div class="form-group <?=form_error('gross_salary') ? 'has-error' : '' ?>">
                            <label for="gross_salarys"><?=$this->lang->line('make_payment_total_allowances')?> <span class="text-red">*</span></label>
                            <input type="text" name="gross_salarys" class="form-control" id="gross_salarys" value="<?=set_value('gross_salarys', $grosssalary)?>" disabled>
                        </div>
                        
<div class="form-group <?=form_error('gross_salary') ? 'has-error' : '' ?>">
                            <label for="gross_salary"><?=$this->lang->line('make_payment_gross_salary')?> <span class="text-red">*</span></label>
                            <input type="text" name="gross_salary" class="form-control" id="gross_salary" value="<?=set_value('gross_salary', $grosssalary+$orginalNetsalary)?>" disabled>
                        </div>
...
<div class="form-group <?=form_error('month') ? 'has-error' : '' ?>">
                    ...
                    <div class="form-group <?=form_error('accountsID') ? 'has-error' : '' ?>">
<label for="account_name"><?=$this->lang->line('account_name')?> <span class="text-red">*</span></label>
                        <div class="">
                                <?php
                                    $array = array();
...
<div class="form-group <?=form_error('voucher_number') ? 'has-error' : '' ?>">
<label for="voucher_number"><?=$this->lang->line('make_payment_voucher')?> <span class="text-red">*</span></label>
<input type="text" name="voucher_number" class="form-control" id="voucher_number" value="CPV-">
</div>
...
<input type="hidden" name="salary_name" class="form-control" id="salary_name" value="Salary - <?php echo $user->name." - ".$usertype->usertype; ?>">
</div>
...
<th>Voucher No.</th>
<th><?php if($manage_salary->salary == 2) { echo $this->lang->line('make_payment_net_salary_hourly'); } else { echo $this->lang->line('make_payment_net_salary'); } ?></th>
                            ...
                            <?php if(customCompute($make_payments)) { $i = 1; foreach($make_payments as $make_payment) { ?>
                                <tr>
                                    ...
                                    <td data-title="Voucher Number">
                                        <?php echo $make_payment->voucher_number; ?>
                                    </td>
...
$(document).ready(function() {
	...
	$('#accountsID').change(function(e) {
		...
		if(a == 1){
			$('#voucher_number').val('CPV-');
		}
		else
		{
			$('#voucher_number').val('BPV-');
		}
    });
