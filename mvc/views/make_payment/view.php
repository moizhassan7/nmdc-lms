                                ...
                                <div class="col-sm-6" style="margin-bottom: 10px;">
                                    <div class="info-box">
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <p style="margin:0 0 20px">
                      <span><?=$this->lang->line("manage_FacultyType")?></span>
                      <?=$user->FacultyType?>
                                            </p>
                                            <p style="margin:0 0 20px">
                      <span><?=$this->lang->line("manage_Department")?></span>
                      <?=$user->Department?>
                                            </p>
                                            <p style="margin:0 0 20px">
                      <span><?=$this->lang->line("manage_designation")?></span>
                      <?=$user->designation?>
                                            </p>
                                        ...
                                        <p style="margin:0 0 20px">
                                            <span><?=$this->lang->line("account_name")?></span>
<?php
$this->data['accounts'] = $this->Accounts_m->get_single_accounts(array('accountsID' => $make_payment->accountsID));
...
?>
                                        ...
                                        <p style="margin:0 0 20px">
                                            <span><?=$this->lang->line("make_payment_voucher")?></span>
                                            <?=$make_payment->voucher_number?>
                                        </p>
