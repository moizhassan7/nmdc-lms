                    ...
                    <?php if(customCompute($single_student)) { ?>
                        ...
                        <div class="col-sm-12" style="padding-left: 0px; padding-right: 0px;">
                            <table class="table table-striped table-bordered" style="margin-top: 10px">
                                <thead>
                                    <tr>
<td style="border-bottom-width: 1px;"><?=$this->lang->line('global_invoice_name')?> <span class="text-red">*</span></td>
<td style="border-bottom-width: 1px;"><input class="form-control" id="invoicename" type="text" name="invoicename" value="<?=$single_student->srroll.'-'.$single_student->srname?>"></td>

<td style="border-bottom-width: 1px;">Account Name <span class="text-red">*</span></td>
<td style="border-bottom-width: 1px;"><?php
                                    $array = array();
                                ...
                                ?></td>
<td style="border-bottom-width: 1px;">Voucher No. <span class="text-red">*</span></td>
<td style="border-bottom-width: 1px;"><input class="form-control" id="voucher_number" type="text" name="voucher_number" value="CRV-"></td>
                                    </tr>
                                </thead>
                                <tbody>
<tr>
<td style="border-bottom-width: 1px;"><?=$this->lang->line('global_description')?> <span class="text-red">*</span></td>
<td style="border-bottom-width: 1px;" colspan="2">
<textarea class="form-control" id="invoicedescription" name="invoicedescription" rows="3" maxlength="128" required></textarea>
</td>
                                        
<td style="border-bottom-width: 1px;"><?=$this->lang->line('global_payment_note')?></td>
<td style="border-bottom-width: 1px;" colspan="2">
<textarea class="form-control" id="note" name="note" rows="3" maxlength="300"></textarea>
</td>
</tr>
                                    <tr>
                                        <td><?=$this->lang->line('global_invoice_number')?> <span class="text-red">*</span></td>
                                        <td colspan="2"><input class="form-control" id="invoicenumber" type="text" name="invoicenumber" value="INV-G-<?=(customCompute($globalpayment_max) > 0) ? $globalpayment_max->globalpaymentID+1 : '1'?>" readonly></td>
                                        <td><?=$this->lang->line('global_payment_year')?> <span class="text-red">*</span></td>
                                        <td colspan="2"><input class="form-control" id="paymentyear" type="text" name="paymentyear" value="<?=date('Y')?>"></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
...
<td style="width:10%">
<?php if(isset($feetypes[$invoice->feetypeID])) { echo $feetypes[$invoice->feetypeID]; } ?><br>
<?php if(isset($panel_payment_type[$invoice->feetypeID])) { 
//echo $panel_payment_type[$invoice->feetypeID]; 
} ?>
<?php echo '<input style="display:none" name="panel_payment_type-'.$invoice->invoiceID.'-'.$invoice->feetypeID.'" class="form-control _panel_payment_type_'.($i -1).'" type="text" value="'.$panel_payment_type[$invoice->feetypeID].'">'; ?>
</td>
...
-->                                                        </select>
                      ...
                      <option value="cheque"><?=$this->lang->line('global_cheque')?></option>
                      <option value="Bank Deposit"><?=$this->lang->line('global_bank')?></option>
                      <option value="Bank Draft"><?=$this->lang->line('global_bankdraft')?></option>
                      <option value="Online Payment"><?=$this->lang->line('global_online')?></option>
                                                        </select>
                                                    </td>
                        ...
                        <div class="assign-fee-payment">
                            ...
                            <table class="table info">
                                ...
                                <tr>
                                    ...
                                    <td><b><?=$this->lang->line('global_roll')?>: </b><?=customCompute($single_student) ? $single_student->srroll : ''?></td>
                                    <td><b><?=$this->lang->line('global_group')?>: </b><?=customCompute($single_group) ? $single_group->group : ''?></td>
                                    
                                </tr>
                                <tr>
                                    <td colspan="2"><b><?=$this->lang->line('global_classes')?>: </b><?=customCompute($single_classes) ? $single_classes->classes : ''?></td>
                                    
                                    <td><b><?=$this->lang->line('global_section')?>: </b><?=customCompute($single_section) ? $single_section->section : ''?></td>
...
<td><?=$paymented->voucher_number?></td>
<td class="textright"><?=$paymented->paymentamount?></td>
                                    ...
                                    <?php if($paymentedPaidStatus) { ?>
                                        <tr>
                                            ...
                                            <td class="boldandred textright" colspan="2"><?=$paymentedPaidAmount?></td>
                                        </tr>
                                    <?php } ?>
...
$('#add_payment').on('click',function(e){
	...
	if(note.val().length > 300) {
        note.addClass('errorClass');
        error++;
    } else {
        note.removeClass('errorClass');
    }
	...
	var panel_payment_type = $('input[name^=panel_payment_type]').map(function(){
        return { panel_payment_typeFieldID: this.name , value: this.value };
    }).get();
    ...
    if(error == 0) {
        ...
        $.ajax({
            ...
            data: {
                ...
                "panel_payment_type" : panel_payment_type,
				"paid" : paid,
                "weaver" : weaver,
                "fine" : fine
            },
