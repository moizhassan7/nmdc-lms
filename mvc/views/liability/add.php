...
<input type="text" name="voucher_number" class="form-control" id="voucher_number" value="CRV-">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                                <?php
                                    ...
                                    echo form_dropdown("liabilityheadID", $array, set_value("liabilityheadID"), "id='liabilityheadID' class='form-control liabilityheadID select2'");
                                ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="namea" name="liability" value="<?=set_value('liability')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_liability")?>" >
                        </div>
                    </div>
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-danger">
                        <p><b>Note:</b> Add your institute liability</p>
                    </div>
                <?php } ?>
            </div>
        </div>
