...
<a style="margin-left:30px;" class="btn btn-success" href="<?php echo base_url('incomeheads/index') ?>">View Income Heads</a>
                        </h5>
                    <?php } ?>
                <?php } ?>
                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th>Voucher No.</th>
                                <th><?=$this->lang->line('income_head')?></th>
...
?>
                           ...
                           <td data-title="Voucher No.">
                            <?=$income->voucher_number?>
                           </td>
                           
<td data-title="<?=$this->lang->line('income_head')?>">
<?php
...
<?php if($income->name == 1 || $income->name == 2){ } else { ?>
