...
<th><?=$this->lang->line('manage_salary_photo')?></th>
<th><?=$this->lang->line('manage_salary_name')?></th>
<th><?=$this->lang->line('manage_FacultyType')?></th>
<th><?=$this->lang->line('manage_Department')?></th>
<th><?=$this->lang->line('manage_designation')?></th>
<th><?=$this->lang->line('manage_salary_jod')?></th>
                 ...
                 <td data-title="<?=$this->lang->line('manage_FacultyType')?>">
                  <?php echo $user->FacultyType; ?>
                 </td>

                 <td data-title="<?=$this->lang->line('manage_Department')?>">
                  <?php echo $user->Department; ?>
                 </td>

                 <td data-title="<?=$this->lang->line('manage_designation')?>">
