            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                                <?php
                                    ...
                                    echo form_dropdown("transfer_from", $array, set_value("accountsID"), "id='transfer_from' class='form-control transfer_from select2'");
                                ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                                <?php
                                    ...
                                    echo form_dropdown("transfer_to", $array, set_value("accountsID"), "id='transfer_to' class='form-control transfer_to select2'");
                                ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
<input type="text" name="voucher_number" class="form-control" id="voucher_number" value="JV-">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            <input type="text" class="form-control" id="namea" name="transfer" value="<?=set_value('transfer')?>" >
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" value="<?=$this->lang->line("add_transfer")?>" >
                        </div>
                    </div>
                ...
                <?php if ($siteinfos->note==1) { ?>
                    <div class="callout callout-danger">
                        <p><b>Note:</b> Add your institute transfer</p>
                    </div>
                <?php } ?>
            </div>
        </div>
