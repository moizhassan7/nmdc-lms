...
<div class="box">
    <div class="box-header">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active"><?=$this->lang->line('menu_edit')?> <?=$this->lang->line('panel_titleb')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
echo "<div class='form-group col-md-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="empcode" name="empcode" value="<?=set_value('empcode', $user->empcode)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-md-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="fathname_id" name="fathname" value="<?=set_value('fathname', $user->fathname)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-md-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="cnic_id" name="cnic" value="<?=set_value('cnic', $user->cnic)?>" data-inputmask="'mask': '99999-9999999-9'"  placeholder="XXXXX-XXXXXXX-X">
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
            <input type="text" class="form-control dob" id="dob" name="dob" value="<?=set_value('dob', date("d-m-Y", strtotime($user->dob)))?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <?php
                                ...
                                echo form_dropdown("state", $stateArray, set_value("state", $user->state), "id='state' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
<input type="text" class="form-control" id="domicile" name="domicile" value="<?=set_value('domicile', $user->domicile)?>" >
                        </div>
                        <span class="control-label">
                    ...
                    ?>
                        ...
                        <div class="">
                            <?php
                                ...
                                echo form_dropdown("marstatus", $marstatusArray, set_value("marstatus", $user->marstatus), "id='marstatus' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
                    ...
                    ?>
                        ...
                        <div class="">
                            <?php
                                ...
                                echo form_dropdown("religion", $religionArray, set_value("religion", $user->religion), "id='religion' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;' id='sectz'>";
                 ...
                 echo form_dropdown("sect", $sectArray, set_value("sect", $user->sect), "id='sect' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo form_dropdown("sectb", $nonmuslimsArray, set_value("sectb", $user->sectb), "id='sectb' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                     ...
                     <?=$this->lang->line("user_nextofkin")?> (Name and Relation)
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="nextofkin" name="nextofkin" value="<?=set_value('nextofkin', $user->nextofkin)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-6' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="bgroup" name="bgroup" value="<?=set_value('bgroup', $user->bgroup)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-6' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="nativelang" name="nativelang" value="<?=set_value('nativelang', $user->nativelang)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input type="text" class="form-control dob" id="AppointmentDate" name="AppointmentDate" value="<?=set_value('AppointmentDate', $user->AppointmentDate)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
        ...
        <?=$this->lang->line("user_jod")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                         <input type="text" class="form-control dob" id="jod" name="jod" value="<?=set_value('jod', $user->jod)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <?php
                                ...
                                echo form_dropdown("FacultyType", $FacultyTypeArray, set_value("FacultyType", $user->FacultyType), "id='FacultyType' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <?php
                                ...
                                echo form_dropdown("Department", $DepartmentArray, set_value("Department", $user->Department), "id='Department' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
         ...
         <?=$this->lang->line("user_designation")?> <span class="text-red">*</span>
					...
					'Assistant Warden Girls Hostel' => 'Assistant Warden Girls Hostel',
							...
							'Clinical Assistant (O-T)' => 'Clinical Assistant (O-T)',
                                ...
                                echo form_dropdown("designation", $designationArray, set_value("designation", $user->designation), "id='designation' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
                  ...
                  <?=$this->lang->line("user_currentdesignation")?> <span class="text-red">*</span>
					...
					'Assistant Warden Girls Hostel' => 'Assistant Warden Girls Hostel',
							...
							'Clinical Assistant (O-T)' => 'Clinical Assistant (O-T)',
                                ...
                                echo form_dropdown("currentdesignation", $currentdesignationArray, set_value("currentdesignation", $user->currentdesignation), "id='currentdesignation' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                   ...
                   <?=$this->lang->line("user_Qualification")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="Qualification" name="Qualification" value="<?=set_value('Qualification', $user->Qualification)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
              ...
              <?=$this->lang->line("user_Specialization")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="Specialization" name="Specialization" value="<?=set_value('Specialization', $user->Specialization)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                   ...
                   <?=$this->lang->line("user_AddQualification")?>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="AddQualification" name="AddQualification" value="<?=set_value('AddQualification', $user->AddQualification)?>" >
                        </div>
                        <span class="control-label">
                    ...
                    <?=$this->lang->line("user_EmploymentMode")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <?php
                                ...
                                echo form_dropdown("EmploymentMode", $EmploymentModeArray, set_value("EmploymentMode", $user->EmploymentMode), "id='EmploymentMode' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
                    ...
                    <?=$this->lang->line("user_EmploymentStatus")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <?php
                                ...
                                echo form_dropdown("EmploymentStatus", $EmploymentStatusArray, set_value("EmploymentStatus", $user->EmploymentStatus), "id='EmploymentStatus' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                ...
                <?=$this->lang->line("user_ContractStartDate")?>
                        ...
                        <div class="">
<?php if(empty($user->ContractStartDate)){ ?>
<input type="text" class="form-control dob" id="ContractStartDate" name="ContractStartDate" value="<?=set_value('ContractStartDate', $user->ContractStartDate)?>" >
<?php }else{ ?>
<input type="text" class="form-control dob" id="ContractStartDate" name="ContractStartDate" value="<?=set_value('ContractStartDate', date("d-m-Y", strtotime($user->ContractStartDate)))?>" >
<?php } ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                ...
                <?=$this->lang->line("user_ContractEndDate")?>
                        ...
                        <div class="">
<?php if(empty($user->ContractEndDate)){ ?>
<input type="text" class="form-control dob" id="ContractEndDate" name="ContractEndDate" value="<?=set_value('ContractEndDate', $user->ContractEndDate)?>" >
<?php }else{ ?>
<input type="text" class="form-control dob" id="ContractEndDate" name="ContractEndDate" value="<?=set_value('ContractEndDate', date("d-m-Y", strtotime($user->ContractEndDate)))?>" >
<?php } ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                ...
                <?=$this->lang->line("user_LastPromotionDate")?>
                        ...
                        <div class="">
<?php if(empty($user->LastPromotionDate)){ ?>
<input type="text" class="form-control dob" id="LastPromotionDate" name="LastPromotionDate" value="<?=set_value('LastPromotionDate', $user->LastPromotionDate)?>" >
<?php }else{ ?>
<input type="text" class="form-control dob" id="LastPromotionDate" name="LastPromotionDate" value="<?=set_value('LastPromotionDate', date("d-m-Y", strtotime($user->LastPromotionDate)))?>" >
<?php } ?>
                        </div>
                        <span class="control-label">
                    ...
                    Shift <span class="text-red">*</span>
                        ...
                        <div class="">
                            <?php
                                ...
                                echo form_dropdown("shift_id", $shiftArray, set_value("shift_id", $user->shift_id), "id='shift_id' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
<option <?php if($user->Matricyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="Matricmarks" class="form-control" id="Matricmarks" value="<?=set_value('Matricmarks'), $user->Matricmarks?>"></td>
<td><input type="text" name="Matricinst" class="form-control" id="Matricinst" value="<?=set_value('Matricinst'), $user->Matricinst?>"></td>
</tr>
<tr>
<th>FA/FSC/Equal</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->Fscyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="Fscmarks" class="form-control" id="Fscmarks" value="<?=set_value('Fscmarks'), $user->Fscmarks?>"></td>
<td><input type="text" name="Fscinst" class="form-control" id="Fscinst" value="<?=set_value('Fscinst'), $user->Fscinst?>"></td>
</tr>
<tr>
<th>BA/BSC</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->BSCyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="BSCmarks" class="form-control" id="BSCmarks" value="<?=set_value('BSCmarks'), $user->BSCmarks?>"></td>
<td><input type="text" name="BSCinst" class="form-control" id="BSCinst" value="<?=set_value('BSCinst'), $user->BSCinst?>"></td>
</tr>
<tr>
<th>MA/MSc</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->MScyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="MScmarks" class="form-control" id="MScmarks" value="<?=set_value('MScmarks'), $user->MScmarks?>"></td>
<td><input type="text" name="MScinst" class="form-control" id="MScinst" value="<?=set_value('MScinst'), $user->MScinst?>"></td>
</tr>
<tr>
<th>BS</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->BSyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="BSmarks" class="form-control" id="BSmarks" value="<?=set_value('BSmarks'), $user->BSmarks?>"></td>
<td><input type="text" name="BSinst" class="form-control" id="BSinst" value="<?=set_value('BSinst'), $user->BSinst?>"></td>
</tr>
<tr>
<th>MS</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->MSyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="MSmarks" class="form-control" id="MSmarks" value="<?=set_value('MSmarks'), $user->MSmarks?>"></td>
<td><input type="text" name="MSinst" class="form-control" id="MSinst" value="<?=set_value('MSinst'), $user->MSinst?>"></td>
</tr>
<tr>
<th>PHD</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->PHDyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="PHDmarks" class="form-control" id="PHDmarks" value="<?=set_value('PHDmarks'), $user->PHDmarks?>"></td>
<td><input type="text" name="PHDinst" class="form-control" id="PHDinst" value="<?=set_value('PHDinst'), $user->PHDinst?>"></td>
</tr>
<tr>
<th>OTHER</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($user->OTHERyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="OTHERmarks" class="form-control" id="OTHERmarks" value="<?=set_value('OTHERmarks'), $user->OTHERmarks?>"></td>
<td><input type="text" name="OTHERinst" class="form-control" id="OTHERinst" value="<?=set_value('OTHERinst'), $user->OTHERinst?>"></td>
</tr>
</table>
</div>
...
echo "<div class='form-group col-sm-12' style='margin-left: -1px;margin-right: -1px;'>";
            ...
            <?=$this->lang->line("user_PermanentAddress")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="PermanentAddress" name="PermanentAddress" value="<?=set_value('PermanentAddress', $user->PermanentAddress)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="phone" name="phone" value="<?=set_value('phone', $user->phone)?>" data-inputmask="'mask': '0399-99999999'" maxlength= "12">
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="LandlineNo" name="LandlineNo" value="<?=set_value('LandlineNo', $user->LandlineNo)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="devicecode" name="devicecode" value="<?=set_value('devicecode', $user->devicecode)?>" >
                        </div>
                         <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="attempcode" name="attempcode" value="<?=set_value('attempcode', $user->attempcode)?>" >
                        </div>
                         <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
    ...
    <input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_user")?>" style="float:right; margin-right:20px;">
                        </div>
                    </div>
