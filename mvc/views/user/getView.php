...
<p><span><?=$this->lang->line("user_username")?> </span>: <?=$profile->username?></p>
                                    ...
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_name")?> </span>: <?=$profile->name?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_empcode")?> </span>: <?=$profile->empcode?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_cnic")?> </span>: <?=$profile->cnic?></p>
                                    </div>
                                    <div class="profile-view-tab" style="width:100%;">
<p><span style="width:30%;"><?=$this->lang->line("user_fathname")?> </span>: <?=$profile->fathname?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_dob")?> </span>: <?=date("d M Y", strtotime($profile->dob))?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_sex")?> </span>: <?=$profile->sex?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_state")?> </span>: <?=$profile->state?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_domicile")?> </span>: <?=$profile->domicile?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_marstatus")?> </span>: <?=$profile->marstatus?></p>
                                    </div>
                                    <div class="profile-view-tab">
...
<p><span>Non-Muslim Religion </span>: <?=$profile->sectb?></p>
                                    ...
                                    <?php } ?>
                                    <div class="profile-view-tab" style="width:100%;">
<p><span style="width:35%;"><?=$this->lang->line("user_nextofkin")?> (Name and Relation)</span>: <?=$profile->nextofkin?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_bgroup")?> </span>: <?=$profile->bgroup?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_nativelang")?> </span>: <?=$profile->nativelang?></p>
                                    </div>
...
<p><span><?=$this->lang->line("user_AppointmentDate")?> </span>: <?= $profile->AppointmentDate ?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("user_AppointmentDate")?> </span>: <?=date("d M Y", strtotime($profile->AppointmentDate))?></p>
<?php } ?>

                                    </div>
                                    <div class="profile-view-tab">
<?php if(empty($profile->jod)){ ?>
<p><span><?=$this->lang->line("user_jod")?> </span>: <?= $profile->jod ?></p>
<?php }else{ ?>
...
<?php } ?>
                                    ...
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_FacultyType")?> </span>: <?=$profile->FacultyType?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_Department")?> </span>: <?=$profile->Department?></p>
                                    </div>
                                    <div class="profile-view-tab" style="width:100%">
<p><span><?=$this->lang->line("user_designation")?> </span>: <?=$profile->designation?></p>
                                    </div>
<div class="clearfix"></div>
                                    <div class="profile-view-tab" style="width:100%">
<p><span><?=$this->lang->line("user_currentdesignation")?> </span>: <?=$profile->currentdesignation?></p>
                                    </div>
<div class="clearfix"></div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_Qualification")?> </span>: <?=$profile->Qualification?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_Specialization")?> </span>: <?=$profile->Specialization?></p>
                                    </div>
                                    <div class="profile-view-tab" style="width:100%;">
<p><span style="width:35%;"><?=$this->lang->line("user_AddQualification")?> </span>: <?=$profile->AddQualification?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_EmploymentMode")?> </span>: <?=$profile->EmploymentMode?></p>
                                    </div>
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_EmploymentStatus")?> </span>: <?=$profile->EmploymentStatus?></p>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<?php if(empty($profile->ContractStartDate)){ ?>
<p><span><?=$this->lang->line("user_ContractStartDate")?> </span>: <?=$profile->ContractStartDate?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("user_ContractStartDate")?> </span>: <?=date("d M Y", strtotime($profile->ContractStartDate))?></p>
<?php } ?>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<?php if(empty($profile->ContractEndDate)){ ?>
<p><span><?=$this->lang->line("user_ContractEndDate")?> </span>: <?=$profile->ContractEndDate?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("user_ContractEndDate")?> </span>: <?=date("d M Y", strtotime($profile->ContractEndDate))?></p>
<?php } ?>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<?php if(empty($profile->LastPromotionDate)){ ?>
<p><span><?=$this->lang->line("user_LastPromotionDate")?> </span>: <?=$profile->LastPromotionDate?></p>
<?php }else{ ?>
<p><span><?=$this->lang->line("user_LastPromotionDate")?> </span>: <?=date("d M Y", strtotime($profile->LastPromotionDate))?></p>
<?php } ?>
                                    </div>
...
<tr>
<th>Matriculation</th>
<td><?=$profile->Matricyear?></td>
<td><?=$profile->Matricmarks?></td>
<td><?=$profile->Matricinst?></td>
</tr>
</tr>
<tr>
<th>FA/FSC/Equal</th>
<td><?=$profile->Fscyear?></td>
<td><?=$profile->Fscmarks?></td>
<td><?=$profile->Fscinst?></td>
</tr>
<tr>
<tr>
<th>BA/BSC</th>
<td><?=$profile->BSCyear?></td>
<td><?=$profile->BSCmarks?></td>
<td><?=$profile->BSCinst?></td>
</tr>
<th>MA/MSc</th>
<td><?=$profile->MScyear?></td>
<td><?=$profile->MScmarks?></td>
<td><?=$profile->MScinst?></td>
</tr>
<tr>
<th>BS</th>
<td><?=$profile->BSyear?></td>
<td><?=$profile->BSmarks?></td>
<td><?=$profile->BSinst?></td>
</tr>
<tr>
<th>MS</th>
<td><?=$profile->MSyear?></td>
<td><?=$profile->MSmarks?></td>
<td><?=$profile->MSinst?></td>
</tr>
<tr>
<th>PHD</th>
...
<tr>
<th>OTHER</th>
<td><?=$profile->OTHERyear?></td>
<td><?=$profile->OTHERmarks?></td>
<td><?=$profile->OTHERinst?></td>
</tr>
</table>
</div>
...
<p class="form_titlez">CORRESPONDENCE INFORMATION</p>
                                    ...
                                    <div class="profile-view-tab" style="width:100%">
<p><span style="width:25%;"><?=$this->lang->line("user_PermanentAddress")?> </span>: <?=$profile->PermanentAddress?></p>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab" style="width:100%">
<p><span style="width:25%;"><?=$this->lang->line("user_address")?> </span>: <?=$profile->address?></p>
                                    </div>
<div class="clearfix"></div>                                    
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_phone")?> </span>: <?=$profile->phone?></p>
                                    ...
                                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("user_LandlineNo")?> </span>: <?=$profile->LandlineNo?></p>
                                    </div>
                                    <div class="profile-view-tab">
