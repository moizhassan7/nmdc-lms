...
<th class="col-lg-1"><?=$this->lang->line('user_name')?></th>
<th class="col-lg-1"><?=$this->lang->line('user_FacultyType')?></th>
<th class="col-lg-1"><?=$this->lang->line('user_Department')?></th>
<th class="col-lg-1"><?=$this->lang->line('user_designation')?></th>
<th class="col-lg-1"><?=$this->lang->line('user_usertype')?></th>
...
<?php } ?>
                 ...
                 <td data-title="<?=$this->lang->line('user_FacultyType')?>">
                  <?php echo $user->FacultyType; ?>
                 </td>

                 <td data-title="<?=$this->lang->line('user_Department')?>">
                  <?php echo $user->Department; ?>
                 </td>

                 <td data-title="<?=$this->lang->line('user_designation')?>">
