    ...
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                ...
                <?php //btn_add_pdf('profile/print_preview', $this->lang->line('pdf_preview'));?>
    ...
    <div id="printablediv">
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            ...
                            <?php } elseif($profile->usertypeID == 3) { ?>
                                ...
                                <li class="list-group-item" style="background-color: #FFF">
                                    <b><?=$this->lang->line('profile_classes')?></b>
                                </li>
                                <li class="list-group-item" style="background-color: #FFF">
     ...
     <?php if(isset($allcountry[$profile->country])) { echo $allcountry[$profile->country]; } ?></p>
                    ...
                    <p><span><?=$this->lang->line("profile_state")?> </span>: <?=$profile->state?></p>
                                        ...
                                        <div class="profile-view-tab">
                    <p><span><?=$this->lang->line("profile_city")?> </span>: <?=$profile->city?></p>
                                        </div>
