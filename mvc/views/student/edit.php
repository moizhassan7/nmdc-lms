                        ...
                        <div class="">
                            <?php
                                $marstatusArray = array(
                                    '0' => $this->lang->line('student_select_marstatus'),
                                    'Single' => 'Single',
                                    'Married' => 'Married',
                                    'Widowed' => 'Widowed',
                                    'Divorced' => 'Divorced',
                                ...
                                echo form_dropdown("marstatus", $marstatusArray, set_value("marstatus", $student->marstatus), "id='marstatus' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="placeofbirth" name="placeofbirth" value="<?=set_value('placeofbirth', $student->placeofbirth)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="passportno" name="passportno" value="<?=set_value('passportno', $student->passportno)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="phone" name="phone" value="<?=set_value('phone', $student->phone)?>" data-inputmask="'mask': '0399-99999999'" type="text" maxlength= "12">
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-8' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="cnicno" name="cnicno" value="<?=set_value('cnicno', $student->cnicno)?>" data-inputmask="'mask': '99999-9999999-9'"  placeholder="XXXXX-XXXXXXX-X">
                        </div>
                        <span class="control-label">
         ...
         <?=$this->lang->line("student_Student_Status")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <?php
                                ...
                                echo form_dropdown("Student_Status", $Student_StatusArray, set_value("Student_Status", $student->Student_Status), "id='Student_Status' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
<option <?php if($student->current_year == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
                        </div>
                        <span class="control-label">
                            <?php echo form_error('studentcurrent_year'); ?>
                        </span>
                    </div>
...
<option value="0">Select</option>
<?php $cyear=2010; for($a=$cyear; $a<=2099; $a++){?>
<option <?php if($student->session_strt == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
                        </div>
                        <span class="control-label">
...
<option value="0">Select</option>
<?php $cyear=2010; for($a=$cyear; $a<=2099; $a++){?>
<option <?php if($student->session_end == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="city" name="city" value="<?=set_value('city', $student->city)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="pcode" name="pcode" value="<?=set_value('pcode', $student->pcode)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            ...
                            ?>
                            <?php
                                echo form_dropdown("pcountry", $country, set_value("pcountry", $student->pcountry), "id='pcountry' class='form-control select2'");
                            ?>
                        </div>
                        <span class="control-label">
...
<label for="chkSame" style="font-size:12px; color:#990000; text-align:right; margin:0;">Same as current address</label></span>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="pstate" name="pstate" value="<?=set_value('pstate', $student->pstate)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="pcity" name="pcity" value="<?=set_value('pcity', $student->pcity)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-9' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="paddress" name="paddress" value="<?=set_value('paddress', $student->paddress)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="ppcode" name="ppcode" value="<?=set_value('ppcode', $student->ppcode)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emername")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emername" name="emername" value="<?=set_value('emername', $student->emername)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emerrel")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emerrel" name="emerrel" value="<?=set_value('emerrel', $student->emerrel)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emer_occ")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emer_occ" name="emer_occ" value="<?=set_value('emer_occ', $student->emer_occ)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emer_phoff")?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emer_phoff" name="emer_phoff" value="<?=set_value('emer_phoff', $student->emer_phoff)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emer_phres")?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emer_phres" name="emer_phres" value="<?=set_value('emer_phres', $student->emer_phres)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emer_cell")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emer_cell" name="emer_cell" value="<?=set_value('emer_cell', $student->emer_cell)?>" data-inputmask="'mask': '0399-99999999'" type="text" maxlength= "12">
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-12' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_emer_address")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="emer_address" name="emer_address" value="<?=set_value('emer_address', $student->emer_address)?>" >
                        </div>
                        <span class="control-label">
...
<option <?php if($student->matricyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="matricmarks" class="form-control" id="matricmarks" value="<?=set_value('matricmarks', $student->matricmarks)?>" ></td>
<td><input type="text" name="matricinst" class="form-control" id="matricinst" value="<?=set_value('matricinst', $student->matricinst)?>" ></td>
</tr>
<tr>
<th>F.SC</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->fscyear == $a){ echo "selected"; }?> value="<?php echo $a ; ?>"><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="fscmarks" class="form-control" id="fscmarks" value="<?=set_value('fscmarks', $student->fscmarks)?>" ></td>
<td><input type="text" name="fscinst" class="form-control" id="fscinst" value="<?=set_value('fscinst', $student->fscinst)?>" ></td>
</tr>
<tr>
<th>O-Levels</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->olevelyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="olevelmarks" class="form-control" id="olevelmarks" value="<?=set_value('olevelmarks', $student->olevelmarks)?>" ></td>
<td><input type="text" name="olevelinst" class="form-control" id="olevelinst" value="<?=set_value('olevelinst', $student->olevelinst)?>" ></td>
</tr>
<tr>
<th>A-Levels</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->alevelyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="alevelmarks" class="form-control" id="alevelmarks" value="<?=set_value('alevelmarks', $student->alevelmarks)?>" ></td>
<td><input type="text" name="alevelinst" class="form-control" id="alevelinst" value="<?=set_value('alevelinst', $student->alevelinst)?>" ></td>
</tr>
<tr>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->intbaccyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="intbaccmarks" class="form-control" id="intbaccmarks" value="<?=set_value('intbaccmarks', $student->intbaccmarks)?>" ></td>
<td><input type="text" name="intbaccinst" class="form-control" id="intbaccinst" value="<?=set_value('intbaccinst', $student->intbaccinst)?>" ></td>
</tr>
<tr>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->amhsyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="amhsmarks" class="form-control" id="amhsmarks" value="<?=set_value('amhsmarks', $student->amhsmarks)?>" ></td>
<td><input type="text" name="amhsinst" class="form-control" id="amhsinst" value="<?=set_value('amhsinst', $student->amhsinst)?>" ></td>
</tr>
<tr>
<th>Diploma</th>
<td>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->diplyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
</td>
<td><input type="text" name="diplmarks" class="form-control" id="diplmarks" value="<?=set_value('diplmarks', $student->diplmarks)?>" ></td>
<td><input type="text" name="diplinst" class="form-control" id="diplinst" value="<?=set_value('diplinst', $student->diplinst)?>" ></td>
</tr>
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_appUHS")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                        <span>Yes</span>
<input type="radio" name="appUHS" id="appUHS" value="Yes" style="height:15px; width:15px;" <?php if($student->appUHS == "Yes"){ echo "checked"; }?>>

<span style="padding-left:20px;">No</span>
<input type="radio" name="appUHS" id="appUHS" value="No" style="height:15px; width:15px;" <?php if($student->appUHS == "No"){ echo "checked"; }?>>
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->appUHSyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_appUHSscr")?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="appUHSscr" name="appUHSscr" value="<?=set_value('appUHSscr', $student->appUHSscr)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_appNUMS")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                        <span>Yes</span>
<input type="radio" name="appNUMS" id="appNUMS" value="Yes" style="height:15px; width:15px;" <?php if($student->appNUMS == "Yes"){ echo "checked"; }?>>

<span style="padding-left:20px;">No</span>
<input type="radio" name="appNUMS" id="appNUMS" value="No" style="height:15px; width:15px;" <?php if($student->appNUMS == "No"){ echo "checked"; }?>>
                        </div>
                        <span class="control-label">
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->appNUMSyear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_appNUMSscr")?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="appNUMSscr" name="appNUMSscr" value="<?=set_value('appNUMSscr', $student->appNUMSscr)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_appOther")?> <span class="text-red">*</span>
                        ...
                        <div class="">
                        <span>Yes</span>
<input type="radio" name="appOther" id="appOther" value="Yes" style="height:15px; width:15px;" <?php if($student->appOther == "Yes"){ echo "checked"; }?>>

<span style="padding-left:20px;">No</span>
<input type="radio" name="appOther" id="appOther" value="No" style="height:15px; width:15px;" <?php if($student->appOther == "No"){ echo "checked"; }?>>
                        </div>
                        <span class="control-label">
...
<option value="0">Select</option>
<?php $cyear=date('Y'); for($a=$cyear; $a>=1947; $a--){?>
<option <?php if($student->appOtheryear == $a){ echo "selected"; }?>><?php echo $a ; ?></option>
<?php } ?>
</select>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-4' style='margin-left: -1px;margin-right: -1px;'>";
                    ...
                    <?=$this->lang->line("student_appOtherscr")?>
                        ...
                        <div class="">
                            <input type="text" class="form-control" id="appOtherscr" name="appOtherscr" value="<?=set_value('appOtherscr', $student->appOtherscr)?>" >
                        </div>
                        <span class="control-label">
...
<input type="radio" name="statusapp" id="statusapp" value="Pakistani" style="height:15px; width:15px;" <?php if($student->statusapp == "Pakistani"){ echo "checked"; }?>>

<span style="padding-left:20px;">Overseas Pakistani Student</span>
<input type="radio" name="statusapp" id="statusapp" value="Overseas Pakistani" style="height:15px; width:15px;" <?php if($student->statusapp == "Overseas Pakistani Student"){ echo "checked"; }?>>

<span style="padding-left:20px;">Foreign Student</span>
<input type="radio" name="statusapp" id="statusapp" value="Foreign" style="height:15px; width:15px;" <?php if($student->statusapp == "Foreign"){ echo "checked"; }?>>
...
<p class="form_titlez" style="padding:0; margin:0;">Hostel Accommodation</p>
                        ...
                        <div class="">
                        <span>Yes</span>
<input type="radio" name="hostelacc" id="hostelacc" value="1" style="height:15px; width:15px;" <?php if($student->hostel == 1){ echo "checked"; }?>>

<span style="padding-left:20px;">No</span>
<input type="radio" name="hostelacc" id="hostelacc" value="0" style="height:15px; width:15px;" <?php if($student->hostel == 0){ echo "checked"; }?>>
                        </div>
                        <span class="control-label">
...
<p class="form_titlez" style="padding:0; margin:0;">Hostel Mess</p>
                        ...
                        <div class="">
                        <span>Yes</span>
<input type="radio" name="hostelmess" id="hostelmess" value="1" style="height:15px; width:15px;" <?php if($student->hostelmess == 1){ echo "checked"; }?>>

<span style="padding-left:20px;">No</span>
<input type="radio" name="hostelmess" id="hostelmess" value="0" style="height:15px; width:15px;" <?php if($student->hostelmess == 0){ echo "checked"; }?>>
                        </div>
                        <span class="control-label">
...
<p class="form_titlez" style="padding:0; margin:0;">Transport</p>
                        ...
                        <div class="">
                        <span>Yes</span>
<input type="radio" name="transport" id="transport" value="1" style="height:15px; width:15px;" <?php if($student->transport == 1){ echo "checked"; }?>>

<span style="padding-left:20px;">No</span>
<input type="radio" name="transport" id="transport" value="0" style="height:15px; width:15px;" <?php if($student->transport == 0){ echo "checked"; }?>>
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
                         <input type="text" class="form-control" id="devicecode" name="devicecode" value="<?=set_value('devicecode', $student->devicecode)?>" >
                        </div>
                        <span class="control-label">
...
echo "<div class='form-group col-sm-3' style='margin-left: -1px;margin-right: -1px;'>";
                    ?>
                        ...
                        <div class="">
<input type="text" class="form-control" id="attcode" name="attcode" value="<?=set_value('attcode', $student->attcode)?>">
                        </div>
                        <span class="control-label">
...
<div class="col-sm-12">
<input type="submit" class="btn btn-success" value="<?=$this->lang->line("update_student")?>" style="float:right; margin-right:20px;">
                        </div>
                    </div>
                </form>
