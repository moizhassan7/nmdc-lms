		    	...
		    	<div class="box box-primary">
		      		<div class="box-body box-profile">
		              	...
		              	<ul class="list-group list-group-unbordered">
		                  	...
		                  	<li class="list-group-item" style="background-color: #FFF">
		                        <b><?=$this->lang->line('student_classes')?></b>
		                    </li>
                            <li class="list-group-item" style="background-color: #FFF">
		                  <a><?=customCompute($class) ? $class->classes : ''?></a>
		                    </li>
		                    <li class="list-group-item" style="background-color: #FFF">
		                    	<b><?=$this->lang->line('student_section')?></b> <a class="pull-right"><?=customCompute($section) ? $section->section : ''?></a>
		                  	</li>
                            <li class="list-group-item" style="background-color: #FFF">
		                    	<b><?=$this->lang->line('student_sess')?></b> <a class="pull-right"><?=$profile->session_strt?> - <?=$profile->session_end?></a>
		                  	</li>
                            <li class="list-group-item" style="background-color: #FFF">
		               <b>Current Year</b> <a class="pull-right"><?=$profile->current_year?></a>
		                  	</li>
                            <li class="list-group-item" style="background-color: #FFF">
		               <b>Student Status</b> <a class="pull-right"><?=$profile->Student_Status?></a>
		                  	</li>
		         		</ul>
		            </div>
		        </div>
		              	...
		              	<div class="active tab-pane" id="profile">
			            	<div class="panel-body profile-view-dis">
			            		<div class="row">
                                    ...
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_roll")?> </span>: <?=$profile->roll?></p>
				                    </div>
				                    ...
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_cell")?> </span>: <?=$profile->phone?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_username")?> </span>: <?=$profile->username?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_marstatus")?> </span>: <?=$profile->marstatus?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_placeofbirth")?> </span>: <?=$profile->placeofbirth?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_nationalitys")?> </span>: <?=$profile->nationality?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_passportno")?> </span>: <?=$profile->passportno?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_cnicnos")?> </span>: <?=$profile->cnicno?></p>
				                    </div>
...
<p class="form_titlez">Current Residential Address</p>
				                    ...
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_city")?> </span>: <?=$profile->city?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_pcode")?> </span>: <?=$profile->pcode?></p>
				                    </div>
				                    <div class="profile-view-tabz">
...
<p class="form_titlez">Permanent Residential Address</p>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_pcountry")?> </span>: 
				                        <?php if(isset($allcountry[$profile->pcountry])) { echo $allcountry[$profile->pcountry]; } ?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_pstate")?> </span>: <?=$profile->pstate?></p>
				                    </div>
				                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_pcity")?> </span>: <?=$profile->pcity?></p>
				                    </div>
                                    <div class="profile-view-tab">
				                        <p><span><?=$this->lang->line("student_ppcode")?> </span>: <?=$profile->ppcode?></p>
				                    </div>
				                    <div class="profile-view-tabz">
				                        <p><span><?=$this->lang->line("student_paddress")?> </span>: <?=$profile->paddress?></p>
				                    </div>
                                    
<div class="clearfix"></div>
<p class="form_titlez">Contact in Case of Emergency</p>
				                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("student_emername")?> </span>: <?=$profile->emername?></p>
				                    </div>
				                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("student_emerrels")?> </span>: <?=$profile->emerrel?></p>
				                    </div>
				                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("student_emer_occ")?> </span>: <?=$profile->emer_occ?></p>
				                    </div>
				                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("student_emer_phoff")?> </span>: <?=$profile->emer_phoff?></p>
				                    </div>
				                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("student_emer_phres")?> </span>: <?=$profile->emer_phres?></p>
				                    </div>
				                    <div class="profile-view-tab">
<p><span><?=$this->lang->line("student_emer_cell")?> </span>: <?=$profile->emer_cell?></p>
				                    </div>
				                    <div class="profile-view-tabz">
<p><span><?=$this->lang->line("student_emer_address")?> </span>: <?=$profile->emer_address?></p>
				                    </div>

									<div class="clearfix"></div>
                                    <p class="form_titlez">Status of Applicant</p>
                                    <div class="profile-view-tab">
				                   <p><span>Applied as </span>: <?=$profile->statusapp?></p>
				                    </div>
                                    <div class="profile-view-tab">
<p><span>Hostel </span>: <?php if($profile->hostel == 1){echo "Yes";}else{echo "No";}?></p>
				                    </div>

                                    <div class="profile-view-tab">
<p><span>Hostel Mess </span>: <?php if($profile->hostelmess == 1){echo "Yes";}else{echo "No";}?></p>
				                    </div>
                                    <div class="profile-view-tab">
<p><span>Transport </span>: <?php if($profile->transport == 1){echo "Yes";}else{echo "No";}?></p>
				                    </div>

<div class="col-sm-12" style="padding:5px;">
<br><p class="form_titlez">Academic Record</p> 
...
<tr>
<th>O-Levels</th>
<td><?=$profile->olevelyear?></td>
<td><?=$profile->olevelmarks?></td>
<td><?=$profile->olevelinst?></td>
</tr>
<th>A-Levels</th>
<td><?=$profile->alevelyear?></td>
<td><?=$profile->alevelmarks?></td>
<td><?=$profile->alevelinst?></td>
</tr>
<tr>
<th>International Baccalaureate</th>
<td><?=$profile->intbaccyear?></td>
<td><?=$profile->intbaccmarks?></td>
<td><?=$profile->intbaccinst?></td>
</tr>
<tr>
<th>American High-School</th>
<td><?=$profile->amhsyear?></td>
<td><?=$profile->amhsmarks?></td>
<td><?=$profile->amhsinst?></td>
</tr>
<tr>
<th>Diploma</th>
<td><?=$profile->diplyear?></td>
<td><?=$profile->diplmarks?></td>
<td><?=$profile->diplinst?></td>
</tr>
</table>
</div>

<div class="col-sm-12" style="padding:5px;">
<br><p class="form_titlez">Appeared in Other Medical College Entry Test</p> 
<table class="table table-bordered" style="margin-bottom:5px;">
<tr>
<th class="form_titlezb">Institution Name</th>
<th class="form_titlezb">Status</th>
<th class="form_titlezb">Year</th>
<th class="form_titlezb">Score</th>
</tr>
<tr>
<th><?=$this->lang->line("student_appUHS")?></th>
<td><?=$profile->appUHS?></td>
<td><?=$profile->appUHSyear?></td>
<td><?=$profile->appUHSscr?></td>
</tr>
<tr>
<th><?=$this->lang->line("student_appNUMS")?></th>
<td><?=$profile->appNUMS?></td>
<td><?=$profile->appNUMSyear?></td>
<td><?=$profile->appNUMSscr?></td>
</tr>
<tr>
<th><?=$this->lang->line("student_appOther")?></th>
<td><?=$profile->appOther?></td>
<td><?=$profile->appOtheryear?></td>
<td><?=$profile->appOtherscr?></td>
</tr>
</table>
</div>
						        </div>
			              	...
			              	<div class="tab-pane" id="parents">
			              		<div class="panel-body profile-view-dis">
					            	<div class="row">
					                    ...
					                    <div class="profile-view-tab">
					                        <p><span><?=$this->lang->line("parents_phone_off")?> </span>: <?=$parents->phone_off?></p>
					                    </div>
                                        <div class="profile-view-tab">
					                        <p><span><?=$this->lang->line("parents_phone_res")?> </span>: <?=$parents->phone_res?></p>
					                    </div>
                                        <div class="profile-view-tab">
					                        <p><span><?=$this->lang->line("parents_cell")?> </span>: <?=$parents->phone?></p>
					                    </div>
					                    <div class="profile-view-tab">
