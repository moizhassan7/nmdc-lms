<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-student"></i> All <?=$this->lang->line('panel_title')?></h3>


        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li class="active">All <?=$this->lang->line('menu_student')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
<a style="margin-left:10px;" class="btn btn-success" href="<?php echo base_url('student/passout_students') ?>">Pass Out Students</a>
                ...
                <?php if(customCompute($students) > 0 ) { ?>
					...
					if($student->Student_Status != "Pass Out"){ 
...
<script type="text/javascript">
    ...
    $('#classesID').change(function() {
        ...
        if(classesID == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('student/student_listd')?>",
                data: "id=" + classesID,
                dataType: "html",
