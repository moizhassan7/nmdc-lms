<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-student"></i> Regular <?=$this->lang->line('panel_title')?></h3>


        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li class="active">Regular <?=$this->lang->line('menu_student')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
<a style="margin-left:30px;" class="btn btn-danger" href="<?php echo base_url('student/detainee_students') ?>">Detainee Students</a>
                ...
                <?php if(customCompute($students) > 0 ) { ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#all" aria-expanded="true">Regular <?=$this->lang->line("student_all_students")?></a></li>
                                ...
                                <div id="hide-table">
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        ...
                                        <th class="col-sm-1"><?=$this->lang->line('student_photo')?></th>
                                                <th class="col-sm-2">
												<?=$this->lang->line('student_name')?></th>
                   ...
                   <?php if(customCompute($students)) {$i = 1; foreach($students as $student) { ?>
                                 <?php if($student->Student_Status=="Regular"){ 
