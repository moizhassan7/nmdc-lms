<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-student"></i> Pass Out <?=$this->lang->line('panel_title')?></h3>


        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li class="active">Pass Out <?=$this->lang->line('menu_student')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
<a style="margin-left:10px;" class="btn btn-danger" href="<?php echo base_url('student/detainee_students') ?>">Detainee Students</a>
                ...
                <?php if(customCompute($students) > 0 ) { ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#all" aria-expanded="true">Pass Out <?=$this->lang->line("student_all_students")?></a></li>
                        ...
                        <div class="tab-content">
                           ...
                           <?php if($student->Student_Status=="Pass Out"){ 
...
<script type="text/javascript">
    ...
    $('#classesID').change(function() {
        ...
        if(classesID == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('student/student_listc')?>",
                data: "id=" + classesID,
                dataType: "html",
