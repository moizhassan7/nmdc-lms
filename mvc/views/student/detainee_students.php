<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-student"></i> Detainee <?=$this->lang->line('panel_title')?></h3>


        <ol class="breadcrumb">
            <li><a href="<?=base_url("dashboard/index")?>"><i class="fa fa-laptop"></i> <?=$this->lang->line('menu_dashboard')?></a></li>
            <li class="active"> Detainee <?=$this->lang->line('menu_student')?></li>
        </ol>
    </div><!-- /.box-header -->
    <!-- form start -->
    <div class="box-body">
...
<a style="margin-left:30px;" class="btn btn-info" href="<?php echo base_url('student/index') ?>">Regular Students</a>
<a style="margin-left:10px;" class="btn btn-primary" href="<?php echo base_url('student/all_students') ?>">All Students</a>
<a style="margin-left:10px;" class="btn btn-success" href="<?php echo base_url('student/passout_students') ?>">Pass Out Students</a>
                ...
                <?php if(customCompute($students) > 0 ) { ?>
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a data-toggle="tab" href="#all" aria-expanded="true">Detainee <?=$this->lang->line("student_all_students")?></a></li>
                        ...
                        <div class="tab-content">
                                    ...
                                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="col-sm-2">Emergency Contact</th>
                            ...
                            <?php if(customCompute($students)) {$i = 1; foreach($students as $student) {
								  if($student->Student_Status=="Detainee"){ 
                 ...
                 Session: <?php echo $student->session_strt; ?> - <?php echo $student->session_end; ?><br>
                 Current: <?php echo $student->current_year; ?>
                                                    </td>
                                                    <td data-title="<?=$this->lang->line('student_roll')?>">
                                                        <?php echo $student->srroll; ?><br>
                                                        <?php echo $setClasses; ?>
                                                    </td>
                                                    <td data-title="Contact">
                                                        <?php echo $student->phone; ?>
                                                    </td>
                                                    <td data-title="Emergency Contact">
                                                        <?php echo $student->emer_cell; ?>
                                                    </td>
                                        ...
                                        <div id="hide-table">
                                            <table class="table table-striped table-bordered table-hover dataTable no-footer">
                                                ...
                                                <tbody>
                                                    ...
                                                    <?php if($student->Student_Status=="Detainee"){ ?>
                                                        <tr>
                                                            <td data-title="<?=$this->lang->line('slno')?>">
                                                                <?php echo $i; ?>
                                                            </td>
...
<script type="text/javascript">
    ...
    $('#classesID').change(function() {
        ...
        if(classesID == 0) {
            ...
            $.ajax({
                type: 'POST',
                url: "<?=base_url('student/student_listb')?>",
                data: "id=" + classesID,
                dataType: "html",
