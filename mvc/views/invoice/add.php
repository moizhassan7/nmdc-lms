...
<div class="paymentmethodDiv hide form-group <?=form_error('accountsID') ? 'has-error' : '' ?>">
             ...
             <?=$this->lang->line("invoice_paymentmethod")?> <span class="text-red">*</span>
                        ...
                        <?php
                            $paymentmethodArray = array(
								...
								'Bank Deposit' => $this->lang->line('BankDeposit'),
								'Bank Draft' => $this->lang->line('BankDraft'),
								'Online Payment' => $this->lang->line('OnlinePayment'),
                            );
...
<div class="paymentmethodDiv hide form-group <?=form_error('voucher_number') ? 'has-error' : '' ?>">
...
<div class="paymentmethodDiv hide form-group <?=form_error('Description') ? 'has-error' : '' ?>">
                        <label for="note">
...
<div class="paymentmethodDiv hide form-group <?=form_error('note') ? 'has-error' : '' ?>">
                        <label for="note">
