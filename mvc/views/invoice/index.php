...
<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-invoice"></i> <?=$this->lang->line('panel_titleb')?></h3>
...
<a style="margin-left:30px;" class="btn btn-success" href="<?php echo base_url('invoice/paidinvoice') ?>">
View Paid Invoices
</a>
<a style="margin-left:10px;" class="btn btn-warning" href="<?php echo base_url('invoice/partially_paid') ?>">
...
?>
                         ...
                         <?php echo date("d M Y", strtotime($maininvoice->maininvoicedate)) ; ?>
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                      ...
                                      if(permissionChecker('invoice_view')) { if($maininvoice->maininvoicestatus != 2) { echo btn_invoice('invoice/payment/'.$maininvoice->maininvoiceID, $this->lang->line('payment')); }} } ?>
                                        <?php 
