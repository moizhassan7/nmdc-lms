<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-invoice"></i> <?=$this->lang->line('panel_titlec')?></h3>
...
<a style="margin-left:10px;" class="btn btn-success" href="<?php echo base_url('invoice/paidinvoice') ?>">
View Paid Invoices
</a>
<?php } ?>
</h5>                       
