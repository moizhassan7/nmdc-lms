<div class="box">
    <div class="box-header">
        <h3 class="box-title"><i class="fa icon-invoice"></i> <?=$this->lang->line('panel_titlea')?></h3>
...
<a style="margin-left:30px;" class="btn btn-danger" href="<?php echo base_url('invoice/index') ?>">
