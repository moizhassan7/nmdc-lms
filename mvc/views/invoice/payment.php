        ...
        <div class="box">
            ...
            <div class="box-body box-profile">
                ...
                <ul class="list-group list-group-unbordered">
                    ...
                    <li class="list-group-item" style="background-color: #FFF">
                        <b><?=$this->lang->line('invoice_class')?> </b>
                        <a class=""><?=customCompute($class) ? $class->classes : ''?></a>
                    </li>
                    <li class="list-group-item" style="background-color: #FFF">
                ...
                <div class="form-group <?=form_error('paymentmethodID') ? 'has-error' : '' ?>">
                    ...
                    <?php
                        ...
                        if($this->session->userdata('usertypeID') == 1 || $this->session->userdata('usertypeID') == 5) {
							...
							$paymentmethodArray['Bank Deposit'] = $this->lang->line('BankDeposit');
							$paymentmethodArray['Bank Draft'] = $this->lang->line('BankDraft');
							$paymentmethodArray['Online Payment'] = $this->lang->line('OnlinePayment');
                        }
...
<label for="voucher_number">Voucher No. <span class="text-red">*</span></label>
<input type="text" name="voucher_number" class="form-control" id="voucher_number" value="CRV-">
</div>
...
<div class="Description form-group <?=form_error('Description') ? 'has-error' : '' ?>">
                        <label for="Description">
             <?=$this->lang->line("invoice_Description")?> <span class="text-red">*</span>
                        </label>
<textarea class="form-control" id="Description" name="Description" rows="5" maxlength="300"><?=set_value('Description')?></textarea>
                        <span class="text-red">
                            <?php echo form_error('Description'); ?>
                        </span>
</div>
                
<div class="note form-group <?=form_error('note') ? 'has-error' : '' ?>">
                        <label for="note">
             <?=$this->lang->line("invoice_note")?>
                        </label>
<textarea class="form-control" id="note" name="note" rows="5" maxlength="300"><?=set_value('note')?></textarea>
                        <span class="text-red">
...
$panel_payment_types = isset($panel_payment_type[$invoice->feetypeID]) ? $panel_payment_type[$invoice->feetypeID] : ''; 
                                            echo '</td>';
...
echo '<input id="panel_payment_type_'.$rand.'" class="form-control" type="hidden" name="panel_payment_type_'.$invoice->invoiceID.'" value="'.$panel_payment_types.'" >';
                                            echo '</td>';
