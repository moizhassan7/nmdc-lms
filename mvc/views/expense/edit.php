            ...
            <div class="col-sm-10">
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                                <?php
                                    ...
                                    echo form_dropdown("accountsID", $array, set_value("accountsID", $expense->accountsID), "id='accountsID' class='form-control accountsID select2'");
                                ?>
                        </div>
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
<input type="text" name="voucher_number" class="form-control" id="voucher_number" value="<?=set_value('voucher_number',$expense->voucher_number)?>">
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <?php 
                        if(form_error('expenseheadID')) 
                            echo "<div class='form-group has-error' >";
                        else     
                            echo "<div class='form-group' >";
                    ?>
                        <label for="expense_head" class="col-sm-2 control-label">
                            <?=$this->lang->line("expense_head")?> <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                                <?php
                                    $array = array();
                                    foreach ($expense_heads as $parent) {
                                        $expense_head = '';
                                        if($parent->expense_head) {
                                            $parentsemail = " (" . $parent->expense_head ." )";
                                        }
                                        $array[$parent->expenseheadID] = $parent->expense_head;
                                    }
echo form_dropdown("expenseheadID", $array, set_value("expenseheadID", $expense->expenseheadID), "id='expenseheadID' class='form-control expenseheadID select2'");
                                ?>
                        </div>
                        <span class="col-sm-4 control-label">
                            <?php echo form_error('expenseheadID'); ?>
                        </span>
                    </div>
