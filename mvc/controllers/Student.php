...
*/
	...
	protected function rules() {
		$rules = array(
			...
			array(
				'field' => 'marstatus',
				'label' => $this->lang->line("student_marstatus"),
				'rules' => 'trim|required|xss_clean|max_length[20]'
			),
			array(
				'field' => 'dob',
			...
			array(
				'field' => 'placeofbirth',
				'label' => $this->lang->line("student_placeofbirth"),
				'rules' => 'trim|required|max_length[60]|xss_clean'
			),
			array(
				'field' => 'nationality',
				'label' => $this->lang->line("student_nationality"),
				'rules' => 'trim|required|max_length[60]|xss_clean'
			),
			array(
				'field' => 'passportno',
				'label' => $this->lang->line("student_passportno"),
				'rules' => 'trim|max_length[25]|xss_clean'
			),
			array(
				'field' => 'phone',
				'label' => $this->lang->line("student_cellno"),
				'rules' => 'trim|required|max_length[25]|min_length[5]|xss_clean'
			),
			array(
				'field' => 'cnicno',
				'label' => $this->lang->line("student_cnicno"),
				'rules' => 'trim|required|max_length[25]|min_length[5]|xss_clean'
			),
			array(
				'field' => 'classesID',
			...
			array(
				...
				'label' => $this->lang->line("student_Student_Status"),
				'rules' => 'trim|required|xss_clean|max_length[50]'
			),
			array(
                'field' => 'current_year',
                'label' => $this->lang->line("student_current_year"),
                'rules' => 'trim|required|max_length[11]|xss_clean|numeric'
            ),
			array(
				'field' => 'country',
			...
			array(
				'field' => 'pcode',
				'label' => $this->lang->line("student_pcode"),
				'rules' => 'trim|max_length[200]|xss_clean'
			),
			array(
				'field' => 'pcountry',
				'label' => $this->lang->line("student_pcountry"),
				'rules' => 'trim|max_length[128]|xss_clean'
			),
			array(
				'field' => 'pstate',
				'label' => $this->lang->line("student_pstate"),
				'rules' => 'trim|required|max_length[128]|xss_clean'
			),
			array(
				'field' => 'pcity',
				'label' => $this->lang->line("student_pcity"),
				'rules' => 'trim|required|max_length[128]|xss_clean'
			),
			array(
				'field' => 'paddress',
				'label' => $this->lang->line("student_paddress"),
				'rules' => 'trim|required|max_length[200]|xss_clean'
			),
			array(
				'field' => 'ppcode',
				'label' => $this->lang->line("student_ppcode"),
				'rules' => 'trim|max_length[200]|xss_clean'
			),
			array(
				'field' => 'emername',
				'label' => $this->lang->line("student_emername"),
				'rules' => 'trim|required|xss_clean|max_length[60]'
			),
			array(
				'field' => 'emerrel',
				'label' => $this->lang->line("student_emerrel"),
				'rules' => 'trim|required|xss_clean|max_length[60]'
			),
			array(
				'field' => 'emer_occ',
				'label' => $this->lang->line("student_emer_occ"),
				'rules' => 'trim|required|xss_clean|max_length[60]'
			),
			array(
				'field' => 'emer_phoff',
				'label' => $this->lang->line("student_emer_phoff"),
				'rules' => 'trim|max_length[25]|min_length[5]|xss_clean'
			),
			array(
				'field' => 'emer_phres',
				'label' => $this->lang->line("student_emer_phres"),
				'rules' => 'trim|max_length[25]|min_length[5]|xss_clean'
			),
			array(
				'field' => 'emer_cell',
				'label' => $this->lang->line("student_emer_cell"),
				'rules' => 'trim|required|max_length[25]|min_length[5]|xss_clean'
			),
			array(
				'field' => 'emer_address',
				'label' => $this->lang->line("student_emer_address"),
				'rules' => 'trim|required|max_length[200]|xss_clean'
			),
			...
			array(
				...
				'rules' => 'trim|required|max_length[150]|valid_email|xss_clean|callback_unique_email'
			),
			array(
				'field' => 'username',
			...
			array(
                'field' => 'devicecode',
                'label' => $this->lang->line("student_devicecode"),
                'rules' => 'trim|required|xss_clean|max_length[11]'
			),
			array(
                'field' => 'attcode',
                'label' => $this->lang->line("student_attcode"),
                'rules' => 'trim|required|xss_clean|max_length[11]'
			),
            array(
                'field' => 'remarks',
...
//1st image
	...
	public function detainee_students() {
		$this->data['headerassets'] = array(
			'css' => array(
				'assets/select2/css/select2.css',
				'assets/select2/css/select2-bootstrap.css'
		...
		if($this->session->userdata('usertypeID') == 3 && $myProfile) {
			...
			$this->data["subview"] = "student/detainee_students";
			$this->load->view('_layout_main', $this->data);
		}
	}
	...
	public function all_students() {
		...
		if($this->session->userdata('usertypeID') == 3 && $myProfile) {
			...
			$this->data["subview"] = "student/all_students";
			$this->load->view('_layout_main', $this->data);
		}
	}

	public function passout_students() {
		$this->data['headerassets'] = array(
			'css' => array(
				'assets/select2/css/select2.css',
				'assets/select2/css/select2-bootstrap.css'
		...
		if($this->session->userdata('usertypeID') == 3 && $myProfile) {
			...
			$this->data["subview"] = "student/passout_students";
			$this->load->view('_layout_main', $this->data);
		}
	}
		...
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
			...
			if($_POST) {
				...
				if ($this->form_validation->run() == FALSE) {
					...
					$array["passportno"] = $this->input->post("passportno");
					$array["phone"] = $this->input->post("phone");
					$array["cnicno"] = $this->input->post("cnicno");
					$array["classesID"] = $this->input->post("classesID");
					$array["sectionID"] = $this->input->post("sectionID");
					$array["studentGroupID"] = $this->input->post("studentGroupID");
					$array["Student_Status"] = $this->input->post("Student_Status");
					$array["current_year"] = $this->input->post("current_year");
					$array["session_strt"] = $this->input->post("session_strt");
					$array["session_end"] = $this->input->post("session_end");
					
					$array["country"] = $this->input->post("country");
					$array["state"] = $this->input->post("state");
					$array["city"] = $this->input->post("city");
					$array["address"] = $this->input->post("address");
					$array["pcode"] = $this->input->post("pcode");
					$array["pcountry"] = $this->input->post("pcountry");
					$array["pstate"] = $this->input->post("pstate");
					$array["pcity"] = $this->input->post("pcity");
					$array["paddress"] = $this->input->post("paddress");
					$array["ppcode"] = $this->input->post("ppcode");
					
					$array["emername"] = $this->input->post("emername");
					$array["emerrel"] = $this->input->post("emerrel");
					$array["emer_occ"] = $this->input->post("emer_occ");
					$array["emer_phoff"] = $this->input->post("emer_phoff");
					$array["emer_phres"] = $this->input->post("emer_phres");
					$array["emer_cell"] = $this->input->post("emer_cell");
					$array["emer_address"] = $this->input->post("emer_address");
					
					$array["fscyear"] = $this->input->post("fscyear");
					$array["fscmarks"] = $this->input->post("fscmarks");
					$array["fscinst"] = $this->input->post("fscinst");
					
					$array["alevelyear"] = $this->input->post("alevelyear");
					$array["alevelmarks"] = $this->input->post("alevelmarks");
					$array["alevelinst"] = $this->input->post("alevelinst");
					
					$array["intbaccyear"] = $this->input->post("intbaccyear");
					$array["intbaccmarks"] = $this->input->post("intbaccmarks");
					$array["intbaccinst"] = $this->input->post("intbaccinst");
					
					$array["amhsyear"] = $this->input->post("amhsyear");
					$array["amhsmarks"] = $this->input->post("amhsmarks");
					$array["amhsinst"] = $this->input->post("amhsinst");
					
					$array["diplyear"] = $this->input->post("diplyear");
					$array["diplmarks"] = $this->input->post("diplmarks");
					$array["diplinst"] = $this->input->post("diplinst");
					
					$array["matricyear"] = $this->input->post("matricyear");
					$array["matricmarks"] = $this->input->post("matricmarks");
					$array["matricinst"] = $this->input->post("matricinst");
					
					$array["olevelyear"] = $this->input->post("olevelyear");
					$array["olevelmarks"] = $this->input->post("olevelmarks");
					$array["olevelinst"] = $this->input->post("olevelinst");
					
					$array["appUHS"] = $this->input->post("appUHS");
					$array["appUHSyear"] = $this->input->post("appUHSyear");
					$array["appUHSscr"] = $this->input->post("appUHSscr");
					
					$array["appNUMS"] = $this->input->post("appNUMS");
					$array["appNUMSyear"] = $this->input->post("appNUMSyear");
					$array["appNUMSscr"] = $this->input->post("appNUMSscr");
					
					$array["appOther"] = $this->input->post("appOther");
					$array["appOtheryear"] = $this->input->post("appOtheryear");
					$array["appOtherscr"] = $this->input->post("appOtherscr");
					
					$array["statusapp"] = $this->input->post("statusapp");
					...
					$array['usertypeID'] = 3;
					$array['library'] = 0;
					$array['hostel'] =  $this->input->post("hostelacc");
					$array['hostelmess'] =  $this->input->post("hostelmess");
					$array['transport'] =  $this->input->post("transport");
					
                	$array["devicecode"]        = $this->input->post("devicecode");
					$array["attcode"]        	= $this->input->post("attcode");
...
$this->reportPDF('studentmodule.css',$this->data, 'student/print_preview');
		...
		if(($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
			...
			if((int)$id && (int)$url) {
				...
				if(customCompute($this->data['student'])) {
					...
					$this->studentrelation_m->delete_studentrelation_by_studentID($id);
	...
	public function student_listb() {
		$classID = $this->input->post('id');
		if((int)$classID) {
			$string = base_url("student/detainee_students/$classID");
			echo $string;
		} else {
			redirect(base_url("student/detainee_students"));
		}
	}
	
	public function student_listc() {
		$classID = $this->input->post('id');
		if((int)$classID) {
			$string = base_url("student/passout_students/$classID");
			echo $string;
		} else {
			redirect(base_url("student/passout_students"));
		}
	}
	
	public function student_listd() {
		$classID = $this->input->post('id');
		if((int)$classID) {
			$string = base_url("student/all_students/$classID");
			echo $string;
		} else {
			redirect(base_url("student/all_students"));
		}
	}
