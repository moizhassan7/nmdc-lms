    ...
    protected function rules($salaryType = 1) {
        $rules = array(
            ...
            array(
                ...
                'label' => $this->lang->line("make_payment_voucher"),
...
$orginalNetsalary = $this->data['salary_template']->basic_salary;
                        ...
                        if($error == FALSE) {
                            ...
                            "basic_salary"      => $orginalNetsalary,
							"total_allowances"  => $grosssalary,
							"gross_salary"      => $grosssalaryz,
                  ...
                  $array['total_hours'] = $this->input->post('total_hours');
						...
						$arrayb = array(
						"name" 			=> $this->input->post("salary_name"),
						"in_exID" 		=> $lastID,
						"in_exheadID" 	=> 0,
						"accountsID" 	=> $this->input->post("accountsID"),
						"voucher_number"  => $this->input->post("voucher_number"),
						"type" 			=> "Salary",
						"sntamount" 	=> $this->input->post("payment_amount"),
						"note"          => $this->input->post("comments"),
						"create_date" 	=> date("Y-m-d"),
						"date" 			=> date("Y-m-d"),
						"in_exday" 		=> date("d", strtotime(date("Y-m-d"))),
						"in_exmonth" 	=> date("m", strtotime(date("Y-m-d"))),
						"in_exyear" 	=> date("Y", strtotime(date("Y-m-d"))),
						'usertypeID' 	=> $usertypeID,
