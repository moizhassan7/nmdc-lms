...
/*			array(
				...
				'rules' => 'trim|required|xss_clean|max_length[30]|callback_unique_paymentmethod'
			)
*/		);
		return $rules;
	}
...
$panel_payment_type=$this->input->post('panel_payment_type');
...
if($panel_payment_type == "Income")
{										
$this->income_m->update_incomez(array('amount' => $paymentamount), $tr_id);
}else{
$this->liability_m->update_liabilityz(array('amount' => $paymentamount), $tr_id);
}
$this->Statement_m->update_statementz(array('recamount' => $paymentamount), $tr_id);
