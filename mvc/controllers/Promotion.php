                ...
                foreach ( $explodeStudents as $key => $studentID ) {
                    ...
                    if ( isset($students[ $studentID ]) ) {
						...
						$this->studentrelation_m->insert_studentrelation($arrayStudentRelation);
                            ...
                            $arrayStudentRelationz = [
                                'srclassesID'         => $setClassesID,
                                'srclasses'           => $setClasses,
                                'srsectionID'         => $setSectionID,
                                'srsection'           => $setSection,
                            ];
$this->studentrelation_m->update_studentrelation_with_multicondition($arrayStudentRelationz, array('srstudentID' => $studentID, 'srschoolyearID' => $promotionYearID));
						}
												
$this->student_m->update_student($array, $studentID);
$this->studentextend_m->update_studentextend_by_studentID([ 'optionalsubjectID' => 0 ], $studentID);
