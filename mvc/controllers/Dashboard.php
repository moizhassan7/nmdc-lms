...
$students = $this->studentrelation_m->get_order_by_studentz([ 'srschoolyearID' => $schoolyearID ]);
$alumni = $this->studentrelation_m->get_order_by_student_passout([ 'srschoolyearID' => $schoolyearID ]);
			...
			$this->data['dashboardWidget']['alumni'] 	  = customCompute($alumni);
