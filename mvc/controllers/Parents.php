	...
	protected function rules() {
		$rules = array(
			...
			array(
				...
				'label' => $this->lang->line("parents_father_profession"),
				'rules' => 'trim|required|xss_clean|max_length[40]'
			),
			array(
				'field' => 'mother_profession',
				'label' => $this->lang->line("parents_mother_profession"),
				'rules' => 'trim|required|xss_clean|max_length[40]'
			),
			array(
				'field' => 'email',
			...
			array(
				'field' => 'phone_off',
				'label' => $this->lang->line("parents_phone_off"),
				'rules' => 'trim|min_length[5]|max_length[25]|xss_clean'
			),
			array(
				'field' => 'phone_res',
				'label' => $this->lang->line("parents_phone_res"),
				'rules' => 'trim|min_length[5]|max_length[25]|xss_clean'
			),
			array(
				'field' => 'phone',
				'label' => $this->lang->line("parents_cell"),
...
$array['phone_off'] = $this->input->post("phone_off");
$array['phone_res'] = $this->input->post("phone_res");
