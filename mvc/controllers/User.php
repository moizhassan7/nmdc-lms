...
*/
	...
	protected function rules() {
		$rules = array(
			...
			array(
                'field' => 'fathname',
                'label' => $this->lang->line("user_fathname"),
                'rules' => 'trim|required|xss_clean|max_length[60]'
			),
			array(
                'field' => 'cnic',
                'label' => $this->lang->line("user_cnic"),
			...
			array(
                'field' => 'state',
                'label' => $this->lang->line("user_state"),
                'rules' => 'trim|required|xss_clean|max_length[60]'
			),
			array(
                'field' => 'domicile',
                'label' => $this->lang->line("user_domicile"),
                'rules' => 'trim|required|xss_clean|max_length[60]'
			),
			array(
                'field' => 'marstatus',
                'label' => $this->lang->line("user_marstatus"),
                'rules' => 'trim|required|xss_clean|max_length[20]'
			),
			array(
                'field' => 'religion',
			...
			array(
                'field' => 'sect',
                'label' => $this->lang->line("user_sect"),
                'rules' => 'trim|max_length[50]|xss_clean'
			),
			array(
                'field' => 'sectb',
                'label' => $this->lang->line("user_sectb"),
                'rules' => 'trim|max_length[50]|xss_clean'
			),
			array(
                'field' => 'nextofkin',
			...
			array(
                'field' => 'nativelang',
                'label' => $this->lang->line("user_nativelang"),
                'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
                'field' => 'bgroup',
                'label' => $this->lang->line("user_bgroup"),
			...
			array(
                'field' => 'AddQualification',
                'label' => $this->lang->line("teacher_AddQualification"),
                'rules' => 'trim|xss_clean|max_length[60]'
			),
			array(
			...
			array(
                ...
                'label' => $this->lang->line("user_HealthFacilityName"),
                'rules' => 'trim|xss_clean|max_length[160]'
			),
			array(
                'field' => 'PermanentAddress',
                'label' => $this->lang->line("user_PermanentAddress"),
			...
			array(
                'field' => 'LandlineNo',
                'label' => $this->lang->line("user_LandlineNo"),
...
$array["jod"] = date("Y-m-d", strtotime($this->input->post("jod")));
			  ...
			  $array["AddQualification"] = $this->input->post("AddQualification");
			  ...
			  $array["BSCyear"]   = $this->input->post("BSCyear");
			  $array["BSCmarks"]   = $this->input->post("BSCmarks");
			  $array["BSCinst"]   = $this->input->post("BSCinst");
			  $array["MScyear"]   = $this->input->post("MScyear");
			  $array["MScmarks"]   = $this->input->post("MScmarks");
			  $array["MScinst"]   = $this->input->post("MScinst");
			  $array["BSyear"]   = $this->input->post("BSyear");
			  $array["BSmarks"]   = $this->input->post("BSmarks");
			  $array["BSinst"]   = $this->input->post("BSinst");
			  $array["MSyear"]   = $this->input->post("MSyear");
			  $array["MSmarks"]   = $this->input->post("MSmarks");
			  $array["MSinst"]   = $this->input->post("MSinst");
			  $array["PHDyear"]   = $this->input->post("PHDyear");
			  $array["PHDmarks"]   = $this->input->post("PHDmarks");
			  $array["PHDinst"]   = $this->input->post("PHDinst");
			  $array["OTHERyear"]   = $this->input->post("OTHERyear");
			  $array["OTHERmarks"]   = $this->input->post("OTHERmarks");
			  $array["OTHERinst"]   = $this->input->post("OTHERinst");
